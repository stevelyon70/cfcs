<cfcomponent>
	...
	<cffunction name="get_rules" description="gets active rules" output="Yes" access="public">
		...
		<cfif len(trim(arguments.dealer_id)) gt 0>
			...
			<table style="border-radius:10px;-moz-border-radius:10px;-webkit-border-radius:10px;background-color:##CBDDDD" width="80%">
			    <tr>
			        <td>ID</td>
			        <td>Rule</td>
			    ...
			    <tr>
			        <td colspan="3">
			        	<a href="#arguments.form_action#?dealer_id=#arguments.dealer_id#&page_action=edit_rule&Price_Rule_ID=0">Create a New Rule</a>
					</td>
			    </tr>
			</table>
...
<!-- #arguments.DSN# -->
		...
		<script type="text/javascript">
			function updateMake(){
				document.getElementById('matrix').action = '#arguments.form_action#?page_action=Update_Make&price_rule_id=#arguments.price_rule_id#&dealer_id=#arguments.dealer_id#'
				document.getElementById('matrix').submit();
			}
			function updateModel(){
				document.getElementById('matrix').action = '#arguments.form_action#?page_action=Update_Model&price_rule_id=#arguments.price_rule_id#&dealer_id=#arguments.dealer_id#'
				document.getElementById('matrix').submit();
			}
			function updateExceptions(){
				document.getElementById('matrix').action = '#arguments.form_action#?page_action=Update_Exceptions&price_rule_id=#arguments.price_rule_id#&dealer_id=#arguments.dealer_id#'
				document.getElementById('matrix').submit();
			}
			function previewRule(){
				document.getElementById('matrix').action = '#arguments.form_action#?page_action=preview_rule&price_rule_id=#arguments.price_rule_id#&dealer_id=#arguments.dealer_id#'
				document.getElementById('matrix').submit();
			}
			function goLive(){
				document.getElementById('matrix').action = '#arguments.form_action#?page_action=Go_Live&price_rule_id=#arguments.price_rule_id#&dealer_id=#arguments.dealer_id#'
				document.getElementById('matrix').submit();
			}
			function noLive(){
				document.getElementById('matrix').action = '#arguments.form_action#?page_action=save_rule&price_rule_id=#arguments.price_rule_id#&dealer_id=#arguments.dealer_id#'
				document.getElementById('matrix').submit();
			}
		</script>
		...
		<form id="matrix" name="matrix" action="#arguments.form_action#?page_action=save_rule" method="post">
							...
							<table cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td align="center" colspan="2">
										<input class="Tabbutton" type="button" value="Update Makes" onclick="updateMake()"/>
									</td>
									<td align="center" colspan="2">
										<cfif arguments.Make_ID gt 0 and listlen(arguments.Make_ID) eq 1>
											<input class="Tabbutton" type="button" value="Update Models" onclick="updateModel()"/>										
										</cfif>
									</td>
								</tr>								
							</table>
							...
							<table cellpadding="0" cellspacing="0">
								...
								<tr>
									<td colspan="3" align="center">
										<input class="Tabbutton" type="button" value="Update Exceptions" onclick="updateExceptions()"/>
									</td>
								</tr>
							</table>
						<cfelse>
			...
			<div>
				<input class="Tabbutton" type="button" value="Go Back" onclick="location.href='#arguments.form_action#?Dealer_ID=#arguments.Dealer_ID#'"/>
