<cfcomponent>
	...
	<cffunction name="get_nav" description="gets current nav listing" output="Yes" access="public">
		...
		<cfquery datasource="#arguments.DSN#" name="Get_Nav_Var">
		SELECT     Nav_ID, Dealer_ID, Nav_Type_ID, Parent_Nav_ID, Nav_Behaviour_ID, Nav_Name, Nav_Alt, Nav_Link, Nav_Mobile_Link, Snippet, Pull, Nav_Image, 
                      ...
                      Mega_Menu, Mega_Height, Mega_Columns, Mega_Glyph_Image, Mega_Right_Float, Mega_Glyph_Color, old_nav_id, var_page_nbr, hotlist
		FROM         navigation_var
		...
		<cfif IsDefined("arguments.pg_nbr")>
			<cfset goback = "&page_type=#arguments.pg_nbr#">
		<cfelse>			
			<cfset goback = "">
		</cfif>
		...
		<form class="form-horizontal" action="#arguments.form_action#?dealer_id=#arguments.Site_ID#&page_action=bulk_update&Nav_Type_ID=#arguments.Nav_Type_ID##goback#" method="post">
			...
			<table style="border-radius:10px;-moz-border-radius:10px;-webkit-border-radius:10px;background-color:##CBDDDD">
				...
				<cfloop query="Get_Nav">
					...
					<tr style="background-color:###iif(currentrow MOD 2,DE('C0C0C0'),DE('B4B6B6'))#">
						...
						<td align="center">
							<a href="#GetFileFromPath(cgi.CF_TEMPLATE_PATH)#?dealer_id=#arguments.Site_ID#&page_action=edit_nav&Nav_ID=#Get_Nav.Nav_ID#&#goback#">Edit</a>
						</td>
						<td align="center">
							<input type="checkbox" name="Nav_Delete" value="#Get_Nav.Nav_ID#"/>
							<input type="hidden" name="robot_food_#Get_Nav.Nav_ID#"  value="#Get_Nav.robot_food#"/>
						</td>
						 <td align="center"> 
							<input type="checkbox" name="hotlist_#Get_Nav.Nav_ID#" <cfif Get_Nav.hotlist eq 1 >checked</cfif> value="1"/>
						</td>  
					</tr>
					<cfif arguments.sub_nav eq "true">
						<tr>
							<td align="right"><a href="#arguments.form_action#?dealer_id=#arguments.Site_ID#&page_action=edit_sub&Parent_Nav_ID=#Get_Nav.Nav_ID#&#goback#">Edit Subnav</a></td>
						</tr>
					</cfif>
		...
		<form class="form-horizontal" action="#arguments.form_action#?dealer_id=#arguments.Site_ID#&page_action=add_nav&Nav_Type_ID=#arguments.Nav_Type_ID##goback#" method="post">
			<input type="hidden" name="Site_ID" value="#arguments.Site_ID#"/>
	...
	<cffunction name="get_sub" description="gets current sub nav" output="Yes" access="public">
		...
		<!---Get Nav--->
		<cfstoredproc datasource="#arguments.DSN#" procedure="Get_Var_Nav">
			...
			<cfloop query="Get_Main_Nav">
				<tr>
					<td colspan="9">
						...
						<cfif arguments.Parent_Nav_ID neq Get_Main_Nav.Nav_ID> - <a href="#arguments.form_action#?dealer_id=#arguments.Site_ID#&page_action=edit_sub&Parent_Nav_ID=#Get_Main_Nav.Nav_ID#&Site_ID=#arguments.Site_ID#">Edit Subnav</a></cfif>
					</td>
				</tr>
				<cfif arguments.Parent_Nav_ID eq Get_Main_Nav.Nav_ID>
					<cfquery datasource="#arguments.DSN#" name="Get_Nav">
						SELECT		Nav_ID,
									...
									Start_Date,
									End_Date,
									Display_Mode,robot_food,var_page_nbr ,hotlist,
						...
						<form class="form-horizontal" action="#arguments.form_action#?dealer_id=#arguments.Site_ID#&page_action=bulk_update&Nav_Type_ID=#arguments.Nav_Type_ID##goback#" method="post">
							...
							<cfloop query="Get_Nav">
								...
								<tr <cfif Get_Nav.currentrow mod 2 eq 0> style="background-color:##aa9d88;"</cfif> >
									...
									<td align="center">
										<a href="#GetFileFromPath(cgi.CF_TEMPLATE_PATH)#?dealer_id=#arguments.Site_ID#&page_action=edit_nav&Nav_ID=#Get_Nav.Nav_ID#&">Edit</a>
									</td>
									<td align="center">
										<input type="checkbox" name="Nav_Delete" value="#Get_Nav.Nav_ID#"/>
										<input type="hidden" name="robot_food_#Get_Nav.Nav_ID#" value="#Get_Nav.robot_food#"/>
					...
					<tr>
						<td style="width:50px">&nbsp;</td>
						<td>
							<form class="form-horizontal" action="#arguments.form_action#?dealer_id=#arguments.Site_ID#&page_action=add_sub&Nav_Type_ID=#arguments.Nav_Type_ID##goback#" method="post">
								<input type="hidden" name="Parent_Nav_ID" value="#arguments.Parent_Nav_ID#"/>
								<input type="hidden" name="Site_ID" value="#arguments.Site_ID#"/>
								<input type="text" name="Nav_Name" maxlength="100"/><br><br>
								<input class="Tabbutton" type="submit" value="Add Nav"/>
	...
	<cffunction name="bulk_update" description="gets current nav listing" output="Yes" access="public">
		...
		<cfloop list="#form.Nav_ID#" index="nid">
			...
			<cfif IsDefined("form.hotlist_#variables.nid#") >
				<cfset variables.hotlist="form.hotlist_#variables.nid#">
			<cfelse>	
				<cfset variables.hotlist="0">
			</cfif>
			...
			<cfif len(trim(evaluate(variables.Nav_Name))) gt 0>
				<cfquery datasource="#arguments.DSN#" name="Update_Nav">
					...
					SET			Nav_Name = <cfqueryparam cfsqltype="CF_SQL_VARCHAR" value="#evaluate(variables.Nav_Name)#" maxlength="100">,
								...
								hotlist = <cfif evaluate(variables.hotlist) eq 1 >1<cfelse>0</cfif>,
	...
	<cffunction name="add_nav" description="gets current nav listing" output="Yes" access="public">	
		...
		<cfquery datasource="#arguments.DSN#" name="Get_H">
			...
			AND			Nav_Type_ID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.Nav_Type_ID#" maxlength="6">
			AND			var_page_nbr = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.pg_nbr#" maxlength="6">
		</cfquery>
		...
		<cfquery datasource="#arguments.DSN#" name="Insert_Nav">
			...
			VALUES
				...
				<cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.pg_nbr#" maxlength="6">,
	...
	<cffunction name="edit_nav" description="detailed edit of a nav element" output="Yes" access="public">
		...
		<form class="form-horizontal" action="#arguments.form_action#?dealer_id=#arguments.Site_ID#&page_action=update_nav&Nav_Type_ID=#arguments.Nav_Type_ID##goback#" method="post" enctype="multipart/form-data">
			<input type="hidden" name="Site_ID" value="#arguments.Site_ID#"/>
			<input type="hidden" name="Nav_ID" value="#Get_Nav.Nav_ID#"/>
			<table>
				<tr>
					<td>Name</td>
					<td><input type="text" name="Nav_Name" value="#Get_Nav.Nav_Name#" maxlength="100"/></td>
				</tr>
				<tr>
					<td>Alt/Title</td>
					<td><input type="text" name="Nav_Alt" value="#Get_Nav.Nav_Alt#" maxlength="100"/></td>
				</tr>
				<cfswitch expression="#Get_Nav.Nav_Behaviour_ID#">
					<cfdefaultcase>
						<tr>
				...
				<cfif #Get_Nav.nav_type_id# EQ 58 or #Get_Nav.nav_type_id# EQ 59 or #Get_Nav.nav_type_id# EQ 60  or #Get_Nav.nav_type_id# EQ 61  or 
						#Get_Nav.nav_type_id# EQ 62  or #Get_Nav.nav_type_id# EQ 63  or #Get_Nav.nav_type_id# EQ 64 >
					<tr>
						<td>Page Number</td>
				...
				<tr>
					<td align="center">
						<cfif Get_Nav.Parent_Nav_ID eq 0>
							<input class="Tabbutton" type="button" value="Go Back" onclick="location.href='#arguments.form_action#?#arguments.Site_ID_Name#=#arguments.Site_ID#&Nav_Type_ID=#arguments.Nav_Type_ID##goback#'"/>
						<cfelse>
							<input class="Tabbutton" type="button" value="Go Back" onclick="location.href='#arguments.form_action#?page_action=edit_sub&site_id=#arguments.site_id#&Nav_Type_ID=2&Parent_Nav_ID=#Get_Nav.Parent_Nav_ID##goback#'"/>
						</cfif>	
					</td>
					<td>
