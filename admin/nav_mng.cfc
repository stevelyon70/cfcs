<!--- Removed Robot Food 06/08/2015 Bob --->
		...
		<form class="form-horizontal" action="#arguments.form_action#?page_action=bulk_update&Nav_Type_ID=#arguments.Nav_Type_ID#" method="post">
			...
			<table style="border-radius:10px;-moz-border-radius:10px;-webkit-border-radius:10px;background-color:##CBDDDD">
				<tr>
					...
					<th>Action</th>
					<th>Delete</th>
					<cfif #arguments.Nav_Type_ID# eq 72  >
						<th>HotList</th> 
					</cfif>
				</tr>
				<cfloop query="Get_Nav">
					...
					<tr style="background-color:###iif(currentrow MOD 2,DE('C0C0C0'),DE('B4B6B6'))#">
						...
						<td align="center">
							<a href="#GetFileFromPath(cgi.CF_TEMPLATE_PATH)#?page_action=edit_nav&Nav_ID=#Get_Nav.Nav_ID#&nav_type_id=#Get_Nav.nav_type_id#&">Edit</a>
						</td>
						<td align="center">
					...
					<cfelse>	
							<input type="hidden" name="hotlist_#Get_Nav.Nav_ID#" value="0"/>
					</cfif>	
					</tr>
						...
						<form class="form-horizontal" action="#arguments.form_action#?page_action=bulk_update&Nav_Type_ID=#arguments.Nav_Type_ID#" method="post">
							...
							<cfloop query="Get_Nav">
								...
								<tr <cfif Get_Nav.currentrow mod 2 eq 0> style="background-color:##aa9d88;"</cfif> >
									...
									<cfelse> --->
										<input type="hidden" name="hotlist_#Get_Nav.Nav_ID#" value="#Get_Nav.hotlist#"/>
									<!--- </cfif> --->
								</tr>
							</cfloop>
							<tr>
...
<!---		<cfset Get_Nav=arguments.Get_Nav>
	...
	<cffunction name="edit_nav" description="detailed edit of a nav element" output="Yes" access="public">
		...
		<cfif #arguments.nav_type_id# eq 16 OR  #arguments.nav_type_id# eq 17 OR  #arguments.nav_type_id# eq 18 OR  #arguments.nav_type_id# eq 19 OR  #arguments.nav_type_id# eq 20 >
			<cfset arguments.store = "icons" >
		</cfif>
		...
		<form class="form-horizontal" action="#arguments.form_action#?page_action=update_nav&Nav_Type_ID=#arguments.Nav_Type_ID#" method="post" enctype="multipart/form-data">
			...
			<table>
				...
				<cfswitch expression="#Get_Nav.Nav_Behaviour_ID#">
					<cfdefaultcase>
						<tr>
							<td><cfif #arguments.Nav_Type_ID# EQ 72 >IMAGE Link<br><span style="color:red;font-size:8pt">Always Direct Link</span><cfelse>Link</cfif></td>
							<td><input type="text" name="Nav_Link" value="#Get_Nav.Nav_Link#" size="120" maxlength="500"/></td>
						</tr>
						<tr>
							<td><cfif #arguments.Nav_Type_ID# EQ 72 >TEXT Link<br><span style="color:red;font-size:8pt">Always New Window</span><cfelse>Mobile Link</cfif></td>
				...
				<cfif arguments.image_only eq "off">
					  <tr>
						<td valign="top"><cfif #arguments.Nav_Type_ID# NEQ 72 >Code Snippet<cfelse>Link Text</cfif></td>	<!--- 01/21/2016 --->
						<td>
	...
	<cffunction name="update_nav" description="detailed edit of a nav element" output="Yes" access="public">
		...
		<cfparam name="form.hotlist" default="0">
