	...
	<cffunction name="form_submit" description="action page for form" output="Yes" access="public">
		...
		<cfelse>
			...
			<cfstoredproc datasource="Ultra10" procedure="Get_Lead_Addresses">
				<cfprocparam type="In" cfsqltype="CF_SQL_INTEGER" dbvarname="@var" value="#arguments.dealer_id#" maxlength="10">
				<cfprocparam type="In" cfsqltype="CF_SQL_INTEGER" dbvarname="@var" value="#arguments.lead_type_id#" maxlength="10">
