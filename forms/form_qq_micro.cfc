<cfcomponent>
					...
					<div class="form-group  qq-input">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-11">
									<input  class="form-control" id="Name" name="Name" type="text" placeholder="* Firstname" size="30" maxlength="50" required >
								</div>
							</div>	
						</div>
					</div>
					...
					<div class="form-group  qq-input">
						<div class="col-md-12">
							<div class="row">
								...
								<div class="col-md-11">
									<input  class="form-control" id="Lastname" name="Lastname" type="text" placeholder="* Lastname" size="30" maxlength="50"  >
								</div>	
							</div>	
						</div>
					</div>
	...
	<cffunction name="form_register_submit" description="default Contest Registration DB Comit" output="yes" access="public">
		...
		<cfset duper = 0 >
		<cfif #Form.Dealer_ID# EQ 203 >
			<cfquery name="chk_dups" datasource="ultra10" >
				SELECT     ID, dealer_id, name, lastname,address1, address2, city, state, zip, email, phone, current_vehicle, ineligible, active, created
				FROM       WD_Contest_Registration
				WHERE		( email = '#form.email#' or phone = '#Form.phone#' )
			</cfquery>
			<cfif #chk_dups.recordcount# GT 0 >
				<cfset duper = 1 >
			</cfif>
		</cfif>
	
		<cfif NOT IsDefined("form.authorization")>	<!--- BOT stopper 11/18/2015 --->
			<cfset duper = 1 >
		</cfif>
			...
			<cfif #url.dealer_id# eq 203 >   <!--- Baierl Subaru --->
				<CFMAIL to="bob@worddealer.net" 
						...
						The following was received from the Baierl Subaru Contest Microsite:
							<font style="font-family:Arial, Helvetica, sans-serif;font-size: 12pt ; font-weight: bold; color: ##000066">
							<ul>
								<li>Firstname: #Form.name#</li>
								<li>Lastname : #Form.lastname#</li>
								<!--- <li>Address 2: #Form.address2#</li>
								<li>City: #Form.city#</li>
								<li>State: #Form.state#</li>
								<li>Zip: #Form.zip#</li> --->
				...
				<CFMAIL to="#Form.email#" 
						...
						<font style="font-family:Arial, Helvetica, sans-serif;font-size: 12pt ; font-weight: bold; color: ##000066">
							...
							In celebration of the Pitt Panther's legacy, and because Baierl is proud to be a part of the team moving forward, we are offering Pitt fans these money saving coupons!<br>
							Simply print this email and present to service advisor to redeem any coupon.  Also, be sure to check out our huge inventory of new and used cars at <a href="http://www.baierl.com">www.baierl.com</a> - where We'll Beat Anybody's Price!<br>
							Hail to Pitt!
							<br><br>
						<font style="font-family:Arial, Helvetica, sans-serif;font-size: 20pt ; font-weight: bold; color: ##000066">
						<table border="0" >
						<tr><td valign="TOP" >
						<img src="http://dealers.wdautos.com/dealer/baierloutbackrunback/images/icons/TheFralicsm.jpg" alt="The Fralic" border="0" class="img-responsive"> 	
						</td>
						<!--- </tr>
						<tr> --->
						<td valign="TOP" >
						<img src="http://dealers.wdautos.com/dealer/baierloutbackrunback/images/icons/TheDorsetsm.jpg" alt="The Dorsett" border="0" class="img-responsive"> 	
						</td>
						</tr>
						<tr><td valign="TOP" >
						<img src="http://dealers.wdautos.com/dealer/baierloutbackrunback/images/icons/TheGreensm.jpg" alt="The Green" border="0" class="img-responsive"> 	
						</td>
						<!--- </tr>
						<tr> --->
						<td valign="TOP" >
						<img src="http://dealers.wdautos.com/dealer/baierloutbackrunback/images/icons/TheMarinosm.jpg" alt="The Marino" border="0" class="img-responsive"> 	
						</td></tr>
						<tr><td valign="TOP" >
						<img src="http://dealers.wdautos.com/dealer/baierloutbackrunback/images/icons/TheFanAppreciationsm.jpg" alt="Fan Appreciation" border="0" class="img-responsive"> 	
						</td>
						<!--- </tr>
						<tr> --->
						<td valign="TOP" >
						<img src="http://dealers.wdautos.com/dealer/baierloutbackrunback/images/icons/TheVictorysm.jpg" alt="The Victory" border="0" class="img-responsive"> 	
						</td></tr>
						</table>
						<BR><BR>
				</cfmail>
