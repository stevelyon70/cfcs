<cfcomponent>
	...
	<cffunction name="qq_default" description="default quote layout" output="yes" access="public">
		...
		<form class="form-horizontal no-pad" action="#arguments.form_action#?form_action=form_submit" id="#arguments.form_name#" name="#arguments.form_name#" method="post">
			<fieldset>
				...
				<div class="form-group qq-input">
					<div class="col-md-12">
						...
						<span class="help-block no-pad">format: xxx-xxx-xxxx</span>
					</div>
				</div>
				<div class="form-group qq-input">
					<div class="col-md-12">
	...
	<cffunction name="form_submit" description="action page for form" output="Yes" access="public">
		...
		<!--- defaults --->
		<cfset variables.WD_BCC="wdpittsburgh@hotmail.com,wdsupport@worlddealer.net">
		<cfset variables.from_email="leadstest@worlddealer.net">
		...
		<!--- Representative: form.Sales_Rep --->
		<cfinvoke component="/cfcs/forms/form_validate" method="text_area" returnvariable="error_message">
			<cfinvokeargument name="text_name" value="Rep Name"/>
			<cfinvokeargument name="text_value" value="#form.Sales_Rep#"/>
			<cfinvokeargument name="error_message" value="#variables.error_message#"/>
		</cfinvoke>
