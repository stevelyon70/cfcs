			...
			<fieldset>
				<div class="form-group">
					<div class="col-md-9 form-divider" align="center">
						<b>WHERE DO YOU WANT YOUR CODE DELIVERED ?</b>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="First_Name"><span class="txt-red">*</span> Your Name :</label>
					<div class="col-md-6">
						<input name="First_Name" class=" input-sm" id="First_Name" type="text" size="20" maxlength="50" placeholder="First Name" required>
						<input name="Last_Name" class=" input-sm" id="Last_Name" type="text" size="20" maxlength="50" placeholder="Last Name" required>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="Phone_1">Phone :</label>
					<div class="col-md-6">
						<input name="Phone_1" class="input-sm" id="Phone_1" type="text" minlength="10" size="50" maxlength="20" placeholder="eg: (412) 555-1212">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input name="Email" class="input-sm" id="Email" type="email" size="50" maxlength="100" placeholder="eg: your.name@gmail.com" required>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="Zip"><span class="txt-red">*</span> Zip :</label>
					<div class="col-md-6">
						<input name="Zip" class="input-sm" id="Zip" type="text" size="50" maxlength="40" placeholder="eg: 15090" >
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="Date"><span class="txt-red">*</span> Test Drive Date/Time :</label>
					<div class="col-md-6">
						<input name="Date" class="input-sm" id="Date" type="Date" maxlength="10" placeholder="mm/dd/yyyy" required>
						<select class="input-sm" name="Time" id="Time" required>
				...
				<div class="form-group">
					<div class="col-md-9 form-divider" align="center">
						<b>WHAT VEHICLE ARE YOU CONSIDERING ?</b>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="Voi_New_Used"><span class="txt-red">*</span> Type / Year :</label>
					<div class="col-md-6">
						<select class="input-sm" name="Voi_New_Used" id="Voi_New_Used" required>
							<option value="N" selected="selected">New</option>
							<option value="U">Pre-Owned</option>
						</select>
						<select  class="input-sm" name="Voi_Year" id="Voi_Year">
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6">
						<select  class="input-sm" name="Voi_Make" id="Voi_Make" required>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6">
						<select  class="input-sm" name="Voi_Model" id="Voi_Model" required>
						</select>
					</div>
				</div>
				<div class="form-group">
