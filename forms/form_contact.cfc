...
<br><br>
	...
	<cffunction name="contact_footer" description="display sidebar modern contact us form" output="Yes" access="public">
		...
		<cfargument name="dsn" required="true">
		<cfargument name="title_class" default="">
		<cfargument name="input_class" default="form-control">
		<cfargument name="button_class" default="">
		<cfargument name="form_action" default="#GetFileFromPath(cgi.CF_TEMPLATE_PATH)#?form_action=form_submit">
		...
		<form action="#arguments.form_action#" method="post">
			...
			<cfif #url.dealer_id# eq 288 ><br></cfif>
		</form>
	...
	<cffunction name="modern_default" description="display default contact us form" output="Yes" access="public">
		...
		<form class="form-horizontal" action="#arguments.form_action#" method="post">
			<fieldset>
				...
				<cfif #url.dealer_id# NEQ 383 >	<!--- Eliminate for SToltz Credit Connection --->
					<div class="form-group">
	...
	<cffunction name="modern_corp" description="display default contact us form" output="Yes" access="public">
		...
		<form class="form-horizontal" action="#arguments.form_action#" method="post">
			<fieldset>
				<input type="hidden" id="Dealer_ID" name="Dealer_ID" value="#arguments.dealer_id#">
				<input type="hidden" id="wdbypass" name="wdbypass" value="1">
				<div class="form-group">
					<label class="control-label col-md-4" for="First_Name"></label>
					<div class="col-md-4">
						<input name="First_Name" class="form-control input-md" id="First_Name" type="text" maxlength="50" placeholder="Name" required>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-md-4" for="Phone_1"></label>
					<div class="col-md-4">
				...
				<div class="form-group">
					<label class="control-label col-md-4" for="Comments"></label>
					<div class="col-md-4">                     
				...
				<div class="form-group" style="margin-top:10px">
					...
					<div class="col-md-7" align="left">
						<input type="submit" class="btn flip-go-btn" id="Contact_Us" value="SEND">
					</div>
				</div>
			</fieldset>
		</form>
	...
	<cffunction name="modern_stoltz" description="display default contact us form" output="Yes" access="public">
		...
		<form class="form-horizontal" action="#arguments.form_action#" method="post">
			<fieldset>
				<input type="hidden" id="Dealer_ID" name="Dealer_ID" value="#arguments.dealer_id#"> 
				<div class="form-group">
					<div class="col-md-12 form-legend">
						#form_legend#
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-12">
						<input name="First_Name" class=" form-control input-md" id="First_Name" type="text" size="50" maxlength="100" placeholder="First Name" required>
					</div>
				</div>
				<div class="form-group">
					<div class="col-md-12">
						<input name="last_Name" class="form-control input-md" id="First_Name" type="text" size="80" maxlength="100" placeholder="Last Name" required>
					</div>
				</div>
				...
				<div class="form-group" style="margin-top:10px">
					<div class="col-md-12" align="left">
						<input type="submit" class="btn stoltz-btn" id="Contact_Us" value="Contact Kevin">
					</div>
				</div>
			</fieldset>
		</form>
	...
	<cffunction name="form_submit" description="action page for form" output="Yes" access="public">
		...
		<cfparam name="form.wdbypass" default="0">
