<cfcomponent>
	...
	<cffunction name="bad_agents" description="block bad robots" output="Yes" access="public">
		...
		<cfif 	left(cgi.HTTP_USER_AGENT,5) eq "Java/"
				...
				or left(cgi.remote_addr,12) eq "191.54.221.5"		<!--- added 11/18/2015 --->
	...
	<cffunction name="banned_ip" description="block already banned ips" output="Yes" access="public">
		...
		<cfif check_ip.recordcount gt 0>
           ...
           <!--- <cfmail from="banned@worlddealer.net" to="slyon@worlddealer.net" subject="banned" type="html">
            	#cgi.REMOTE_ADDR#<br/><hr/>
					#cgi.REMOTE_HOST#<br/><hr/>
					#cgi.CF_TEMPLATE_PATH#<br/><hr/>
					#cgi.HTTP_USER_AGENT#<br/><hr/>
					#cgi.SERVER_NAME#<br/><hr/>
					#cgi.HTTP_REFERER#
            </cfmail>--->
			<cfabort>
		</cfif>
