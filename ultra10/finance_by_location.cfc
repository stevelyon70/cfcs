<cfcomponent>
	...
	<cffunction name="modern_standard" description="shows finance links by location" output="Yes" access="public">
		...
		<cfargument name="primary_label" default="Apply Now">
		...
		<div class="row">
			<cfloop query="Get_Locations">
				<div class="col-md-4">
					...
					<a class="#arguments.service_btn_class#" href="#Get_Locations.Link_Finance#" target="_blank" title="Financing Application">#arguments.primary_label#</a>
				</div>
