<cfcomponent>
	...
	<cffunction name="wide" description="slideshow" output="Yes" access="public">
        ...
        <!-- variable_wow_slider -->
			...
			<cfset url.Non_Global_Footer_Scripts= url.Non_Global_Footer_Scripts & '<script type="text/javascript" src="http://#cgi.server_name#/wowslider/1048/engine1/wowslider.js"></script>'>
			<cfset url.Non_Global_Footer_Scripts= url.Non_Global_Footer_Scripts & '<script type="text/javascript" src="http://#cgi.server_name#/wowslider/1048/engine1/script.js"></script>'>
	...
	<cffunction name="huge" description="slideshow" output="Yes" access="public">
