<cfcomponent>
	...
	<cffunction name="modern_standard" description="shows SERVICE links by location" output="Yes" access="public">
		...
		<cfargument name="primary_label" default="Service Department">
		...
		<div class="row">
			<cfloop query="Get_Locations">
				<div class="col-md-4">
					...
					<a class="#arguments.service_btn_class#" href="#Get_Locations.Link_Service#" target="_blank" title="Service Department">#arguments.primary_label#</a>
				</div>
