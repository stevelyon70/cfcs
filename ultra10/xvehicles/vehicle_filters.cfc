				...
				<div class="panel-group" id="accordion">
							...
							<div id="collapseModel" class="panel-collapse collapse">
								<div class="panel-body">
									<cfloop query="Get_Models">
										<a class="btn-srp-filt pull-left" href="#arguments.srp_action#?&new_used=#url.new_used#&year=#url.year#&make=#url.make#&model=#Get_Models.V_Model#&body=#url.body#&drivetrain=#url.drivetrain#&transmission=#url.transmission#&color=#url.color#&dealer_id=#url.dealer_id#&minprice=#url.minprice#&maxprice=#url.maxprice#">#Get_Models.V_Model#</a>	
									</cfloop>
								</div>
							</div>
						</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapsePrice" class="panel-collapse collapse">
							<div class="panel-body">
								<a class="btn-sm btn-srp-price" href="#arguments.srp_action#?&new_used=#url.new_used#&year=#url.year#&make=#url.make#&model=#url.model#&body=#url.body#&drivetrain=#url.drivetrain#&transmission=#url.transmission#&dealer_id=#url.dealer_id#&color=#url.color#&maxprice=10000">Under $10,000</a>
								<a class="btn-sm btn-srp-price" href="#arguments.srp_action#?&new_used=#url.new_used#&year=#url.year#&make=#url.make#&model=#url.model#&body=#url.body#&drivetrain=#url.drivetrain#&transmission=#url.transmission#&dealer_id=#url.dealer_id#&color=#url.color#&maxprice=20000&minprice=10000">$10,000-$20,000</a>
								<a class="btn-sm btn-srp-price" href="#arguments.srp_action#?&new_used=#url.new_used#&year=#url.year#&make=#url.make#&model=#url.model#&body=#url.body#&drivetrain=#url.drivetrain#&transmission=#url.transmission#&dealer_id=#url.dealer_id#&color=#url.color#&maxprice=30000&minprice=20000">$20,000-$30,000</a>
								<a class="btn-sm btn-srp-price" href="#arguments.srp_action#?&new_used=#url.new_used#&year=#url.year#&make=#url.make#&model=#url.model#&body=#url.body#&drivetrain=#url.drivetrain#&transmission=#url.transmission#&dealer_id=#url.dealer_id#&color=#url.color#&maxprice=50000&minprice=30000">$30,000-$50,000</a>
								<a class="btn-sm btn-srp-price" href="#arguments.srp_action#?&new_used=#url.new_used#&year=#url.year#&make=#url.make#&model=#url.model#&body=#url.body#&drivetrain=#url.drivetrain#&transmission=#url.transmission#&dealer_id=#url.dealer_id#&color=#url.color#&maxprice=75000&minprice=50000">$50,000-$75,000</a>
								<a class="btn-sm btn-srp-price" href="#arguments.srp_action#?&new_used=#url.new_used#&year=#url.year#&make=#url.make#&model=#url.model#&body=#url.body#&drivetrain=#url.drivetrain#&transmission=#url.transmission#&dealer_id=#url.dealer_id#&color=#url.color#&minprice=75000">Over $75,000</a>
							</div>
						</div>
					</div>
				</div>
