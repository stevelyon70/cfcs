			...
			<fieldset>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-8">
							<input name="first_name" class="form-control modal-input input-md" id="first_name" type="text" placeholder="First Name" maxlength="50" value="#url.first_name#" required/>
						</div>
						<label class="col-md-4 control-label modal-label visible-md visible-lg" for="last_name"><em>*</em> Last Name</label>  
						<div class="col-md-8">
							<input name="last_name" class="form-control modal-input input-md" id="last_name" type="text" placeholder="Last Name" maxlength="50" value="#url.last_name#" required/>
						</div>
						<label class="col-md-4 control-label modal-label visible-md visible-lg" for="email"><em>*</em> Email</label>  
						<div class="col-md-8">
							<input name="email" class="form-control modal-input input-md" id="email" type="email" placeholder="Email" maxlength="100" value="#url.email#" required/>
						</div>
						<label class="col-md-4 control-label modal-label visible-md visible-lg" for="phone"> Phone</label>  
						<div class="col-md-8">
							<input name="phone_1" class="form-control modal-input input-md" id="phone_1" type="text" placeholder="Phone" maxlength="10" value="#url.phone_1#" />
