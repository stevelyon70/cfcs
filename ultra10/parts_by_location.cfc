<cfcomponent>
	...
	<cffunction name="modern_standard" description="shows PARTS links by location" output="Yes" access="public">
		...
		<cfargument name="primary_label" default="Parts Department">
		...
		<div class="row">
			<cfloop query="Get_Locations">
				<div class="col-md-4">
					...
					<a class="#arguments.service_btn_class#" href="#Get_Locations.Link_Parts#" target="_blank" title="Parts Department">#arguments.primary_label#</a>
				</div>
