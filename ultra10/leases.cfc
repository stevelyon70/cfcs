			...
			<cfloop query="get_pg_list" >
				...
				<cfelse>
					<cfif #get_pg_list.img_location# EQ 1 AND #get_pg_list.Image# NEQ "" >
						<div class="row">
							<div class="col-md-12">
								<img  alt="Lease Specials at #Get_Dealer_Details.Display_Name#"  class="img-responsive" src="http://dealers.wdautos.com/dealer/#Get_Dealer_Details.Dealer_Directory#/images/library/#get_pg_list.Image#"  >
							</div>
						</div>	
						<div class="row"><div class="col-md-12">&nbsp;</div></div>
					</cfif>
		...
		<table>
			...
			<tr><td>&nbsp;</td></tr>
				<cfloop query="get_pg_list" >
					...
					<cfelse>	
						<cfif #get_pg_list.img_location# EQ 1 AND #get_pg_list.Image# NEQ "" >
							<tr><td align="center"><img  alt="Lease Specials at #Get_Dealer_Details.Display_Name#"  class="img-responsive" src="http://dealers.wdautos.com/dealer/#Get_Dealer_Details.Dealer_Directory#/images/library/#get_pg_list.Image#"  ></td></tr>	
							<tr><td>&nbsp;</td></tr>
						</cfif>
