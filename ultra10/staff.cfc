		...
		<cfparam name="url.old_make" default="">
				...
				<cfloop index="x" from="1" to="#a_Last[d]#" step="#stepper#" >
					...
					<cfif #hld_dept# NEQ #d_dept_id[d]# >
						<div class="row">
							<div class="col-md-12">
							 <h2 class="form-divider">#d_dept_name[d]#</h2>
							</div>
						</div>
						<div class="row">&nbsp;</div>
					...
					<div class="row">
						<div class="col-md-3">
							 <cfif #a_Staff_Image[d][x]# NEQ "">  
								<img src="#variables.fullpath##a_Staff_Image[d][x]#" class="img-responsive" alt="#a_First_Name[d][x]# #a_Last_Name[d][x]#"   >
							  </cfif>  
							<p></p>
							...
							<cfif #a_Note[d][x]# NEQ ""><br>#a_Note[d][x]#</cfif>
							<cfif #a_Staff_Link[d][x]# NEQ ""><br><a href="#a_Staff_Link[d][x]#" target="_blank" >Read My Dealerater Reviews</a></cfif></p>
						</div>
						<cfif #a_bio[d][x]# NEQ "">
						...
						<cfif #nxt# LTE #a_Last[d]# AND #d_dept_id[d]# EQ #hld_dept# >
							<div class="col-md-3">
							 <cfif #a_Staff_Image[d][nxt]# NEQ ""> 
								<img src="#variables.fullpath##a_Staff_Image[d][nxt]#" class="img-responsive" alt="#a_First_Name[d][nxt]# #a_Last_Name[d][nxt]#"   >
							 </cfif>  
								<p></p>
								...
								<cfif #a_Note[d][nxt]# NEQ ""><br>#a_Note[d][nxt]#</cfif>
								<cfif #a_Staff_Link[d][nxt]# NEQ ""><br><a href="#a_Staff_Link[d][nxt]#" target="_blank" >Read My Dealerater Reviews</a></cfif></p>
							</div>
							<cfif #a_bio[d][nxt]# NEQ "">
								<cfinvoke component="/cfcs/ultra10/popups" method="staff_bio">
									...
									<cfinvokeargument name="Staff_Name" value="#a_First_Name[d][nxt]# #a_Last_Name[d][nxt]#"/>
		...
		<table>
			...
			<cfloop index="d" from="1" to="#last_dept#" >
				...
				<cfloop index="x" from="1" to="#a_Last[d]#" step="#stepper#" >
					...
					<cfif #hld_dept# NEQ #d_dept_id[d]# >
						<tr><td>&nbsp;</td></tr>
						<tr style="background-color: ##0a5fa0 ;">
							<td>
							 <h2 style="color:white;">#d_dept_name[d]#</h2>
							</td>
						</tr>
						<cfset hld_dept = #d_dept_id[d]# >
					</cfif>
					<tr>
						...
						<cfif #nxt# LTE #a_Last[d]# AND #d_dept_id[d]# EQ #hld_dept# >
							<td width="25%">
								<img src="#variables.fullpath##a_Staff_Image[d][nxt]#" class="img-responsive" alt="#a_First_Name[d][nxt]# #a_Last_Name[d][nxt]#"   ><p></p>
								<p>#a_First_Name[d][nxt]# #a_Last_Name[d][nxt]#
								<cfif #a_Staff_Position[d][nxt]# NEQ ""><br>#a_Staff_Position[d][nxt]#</cfif>
