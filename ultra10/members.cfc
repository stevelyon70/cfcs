...
<!--- Data Collection --->
	...
	<cfif IsDefined("form.submit")>
		...
		<cfif #get_cust.recordcount# NEQ 0 >
			...
			<div class="row">
				<div class="col-md-12" align="center" >
					<a href="http://#cgi.server_name#/dealer/findlaytoyota/images/members/printablecoupon.png" target="_blank"><img class="img-responsive" src="http://dealers.wdautos.com/dealer/findlaytoyota/images/members/printablecoupon.png" width="400px" height="190px" /></a>
				</div>
			</div>
			<cfexit>
		...
		<div class="row">
			<div class="col-md-2">
				<img alt="Members"  class="img-responsive" src="http://dealers.wdautos.com/dealer/findlaytoyota/images/members/logo_findlaytoyota.png"/>
			</div>
			<div class="col-md-10">
		...
		<cfif #mbr_id[1]# EQ 17 >
			<div class="row">
				<div class="col-md-12">	
					...
					<img alt="Members"  class="img-responsive" src="http://dealers.wdautos.com/dealer/findlaytoyota/images/members/#mbr_img[1]#"  >
				</div>
			</div>
		</cfif>
		<cfloop index="x" from="2" to="#tot_pics#" step="2" >
			<div class="row">
				<div class="col-md-6">
					<a href="#mbr_logo_url[x]#" target="_blank"><img alt="Members"  class="img-responsive" src="http://dealers.wdautos.com/dealer/findlaytoyota/images/members/#mbr_img[x]#"  ></a>
				</div>	
				<cfif #x#+1 LTE #tot_pics# >
					<div class="col-md-6">
						<a href="#mbr_logo_url[x+1]#" target="_blank"><img alt="Members"  class="img-responsive" src="http://dealers.wdautos.com/dealer/findlaytoyota/images/members/#mbr_img[x+1]#"  ></a>
				</div>	
				</cfif>
			</div>	
			<div class="row"><div class="col-md-12">&nbsp;</div></div>
	...
	<cfif IsDefined("form.submit")>
		...
		<cfif #get_cust.recordcount# NEQ 0 >
			...
			<div class="row">
				<div class="col-md-6" align="right" >
					<a href="http://#cgi.server_name#/dealer/findlaytoyota/pdfs/ft_specials.pdf" target="_blank"><img alt="Members"  class="img-responsive" src="http://dealers.wdautos.com/dealer/findlaytoyota/images/members/btn_ftmembers.png" border="1"/></a>
				</div>
				<div class="col-md-6" align="left" >
					<a href="http://#cgi.server_name#/dealer/findlaytoyota/member_discount_page.cfm" target="_blank"><img alt="Members"  class="img-responsive"  src="http://#cgi.server_name#/dealer/findlaytoyota/images/members/btn_ftmembers_sheet.png" border="1"/></a>
				</div>
			</div>
			<div class="row"><div class="col-md-12">&nbsp;</div></div>
			<div class="row">
				<div class="col-md-12" align="center" >
					<a href="http://#cgi.server_name#/dealer/findlaytoyota/images/members/printablecoupon.png" target="_blank"><img alt="Members"  class="img-responsive" src="http://dealers.wdautos.com/dealer/findlaytoyota/images/members/printablecoupon.png" width="400px" height="190px" /></a>
				</div>
			</div>
			<cfexit>
								...
								<tr>
									<td class="blacktitles" align="left" valign="MIDDLE"  >	
										<table cellpadding="1" cellspacing="0" border="0" width="90%" align="center">
											<tr><!--- <img src="http://#cgi.server_name#/dealer/findlaytoyota/images/members/#mbr_img[1]#"  > --->
												<td class="blacktitles" align="center" colspan="2" valign="MIDDLE"  >	
													<a href="http://findlaytoyota.com/dealer/findlaytoyota/findlay_toyota_business_solutions.cfm" target="_blank"> 
													<img src="http://#cgi.server_name#/dealer/findlaytoyota/images/members/#mbr_img[1]#" alt="Members"  border="0" ></a>
												</td>
											</tr>
										</table>			
									</td>
								...
								<tr>
									<td class="blacktitles" align="left" valign="MIDDLE"  >	
										<table cellpadding="3" cellspacing="2" border="0" width="90%" align="center">
											<tr> <!--- <img src="http://#cgi.server_name#/dealer/findlaytoyota/images/members/#mbr_img[x]#"  > --->
												<td class="blacktitles" align="center" width="40%" valign="MIDDLE"  >	
													<a href="#mbr_logo_url[x]#" target="_blank"><img alt="Members"  src="http://#cgi.server_name#/dealer/findlaytoyota/images/members/#mbr_img[x]#" border="0" ></a>
												</td> <!--- <img src="http://#cgi.server_name#/dealer/findlaytoyota/images/members/#mbr_img[x+1]#"  > --->
												<cfif #x#+1 LTE #tot_pics# >
													<td class="blacktitles" align="center" width="40%" valign="MIDDLE"  >	
														<a href="#mbr_logo_url[x+1]#" target="_blank"><img alt="Members" src="http://#cgi.server_name#/dealer/findlaytoyota/images/members/#mbr_img[x+1]#" border="0" ></a>
													</td>
												</cfif>
											</tr>
										</table>			
