<cfcomponent>
	...
	<cffunction name="modern" description="shows a standard header" output="Yes" access="public">
		...
		<section class="section-spl">
						...
						<div class="row">
							<div class="col-md-12 pad-top-10">
								<cfinvoke component="#arguments.component_name#" method="#arguments.method_name#">
									...
									<cfinvokeargument name="Get_Meta_Info" value="#arguments.Get_Meta_Info#"/>
									<cfinvokeargument name="Get_Nav" value="#arguments.Get_Nav#"/>
									<cfinvokeargument name="Get_Phones" value="#arguments.Get_Phones#"/>
			...
			<cfif #url.dealer_id# eq 70 and #lcase(cgi.script_name)# eq "/dealer/findlaytoyota/toyota_mvp.cfm" >
				<div class="container">
					<div class="row">
						<div class="col-md-12" align="left">
						<h3><b>Tell Us What You Are Interested In So We Can Help</b></h3>
						</div>
					</div>	
					<div class="row">
						<div class="col-md-12">
							<cfinclude template="section_fmc_form.cfm">
						</div>
					</div>
				</div>		
			</cfif>
