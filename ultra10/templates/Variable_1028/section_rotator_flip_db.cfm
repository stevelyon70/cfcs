...
<cfquery name="get_flippers" datasource="Ultra10" >
	SELECT	ID, dealer_id, front_image, panel_width, panel_height, 
						...
						<div class="flipper">
							<div class="front" style="align:center">
								<!--- <div class="vertical-text">Click to View Options!</div>  --->
						         <img src="http://dealers.wdautos.com/dealer/#arguments.assets#/images/icons/#get_flippers.front_image#" class="img-responsive"> 
							</div>
							<div class="back" style="align:center">
								<div style="font-size:28px;"><cfif #get_flippers.back_title# NEQ "" >#get_flippers.back_title#<br></cfif>
...
<style type="text/css">
.cta-button {
	-moz-box-shadow:inset 0px 1px 0px 0px ##get_flippers.cta_btn_background#;							/*  DB Feed */
	-webkit-box-shadow:inset 0px 1px 0px 0px ##get_flippers.cta_btn_background#;							/*  DB Feed */
	box-shadow:inset 0px 1px 0px 0px ##get_flippers.cta_btn_background#;							/*  DB Feed */
	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, ##get_flippers.cta_btn_background#), color-stop(1, ##get_flippers.cta_btn_background#) );							/*  DB Feed */
	background:-moz-linear-gradient( center top, ##get_flippers.cta_btn_background# 5%, ##get_flippers.cta_btn_background# 100% );							/*  DB Feed */
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='##get_flippers.cta_btn_background#', endColorstr='##get_flippers.cta_btn_background#');							/*  DB Feed */
	background-color:##get_flippers.cta_btn_background#;							/*  DB Feed */
	border:1px solid ##get_flippers.cta_btn_background#;
	color:##get_flippers.button1_text#;						/*  DB Feed */
	text-shadow:1px 1px 0px ##get_flippers.cta_btn_background#;
}
.cta-button:hover {
	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, ##get_flippers.cta_btn_background#), color-stop(1, ##get_flippers.cta_btn_background#) );							/*  DB Feed */
	background:-moz-linear-gradient( center top, ##get_flippers.cta_btn_background# 5%, ##get_flippers.cta_btn_background# 100% );							/*  DB Feed */
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='##get_flippers.cta_btn_background#', endColorstr='##get_flippers.cta_btn_background#');							/*  DB Feed */
	background-color:##get_flippers.cta_btn_background#;
	color:##get_flippers.button1_text#;							/*  DB Feed */
}.cta-button:active {
	color:##get_flippers.button1_text#;							/*  DB Feed */
}
		...
		.flip-container, .front, .back {
			max-width: #get_flippers.button1_text#px;    /* Panel width   */								/*  DB Feed */
			height: #get_flippers.button1_text#px;    /* Panel Height   */							/*  DB Feed */
		}


		.back {
			background: ##get_flippers.back_bg_color#;							/*  DB Feed */
			
		}


		.back-title {
			color: ##get_flippers.back_title_color#;							/*  DB Feed */
