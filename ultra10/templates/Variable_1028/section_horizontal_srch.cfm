<cfoutput>
		...
		<section class="section-horizontal-srch">
			<div class="container pad-top-10 visible-md visible-lg visible-sm visible-xs">
				<div class="row">
					<div class="col-md-12 pad-top-10 visible-sm visible-xs visible-lg visible-md" style="text-align:center;border:1px solid white">  
				...
				<div class="row">
					<div class="col-md-12  pad-top-10" style="align:center">
						<cfinvoke component="/cfcs/ultra10/tool_search_engine" method="horizontal_search">
