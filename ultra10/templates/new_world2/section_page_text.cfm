...
<!--- Page Text --->  
	...
	<cfquery name="gt_text" datasource="Ultra10">
		SELECT	  id, dealer_id, page_type, make, title, title_font_family, title_font_size, title_font_color, title_font_weight, title_font_decoration, page_text, page_font_family, 
                      ...
                      trailer_font_decoration, link1, link1_btn_background, link1_btn_text_font_size, link1_btn_text_font_color, link1_btn_text_font_family, link1_btn_text_font_weight, 
                      link1_btn_text_decoration, link_target1, link_txt1, link2, link2_btn_background, link2_btn_text_font_size, link2_btn_text_font_color, link2_btn_text_font_family, 
                      link2_btn_text_font_weight, link2_btn_text_decoration, link_target2, link_txt2, link3, link3_btn_background, link3_btn_text_font_size, link3_btn_text_font_color, 
                      link3_btn_text_font_family, link3_btn_text_font_weight, link3_btn_text_decoration, link_target3, link_txt3, link4, link4_btn_background, link4_btn_text_font_size, 
                      link4_btn_text_font_color, link4_btn_text_font_family, link4_btn_text_font_weight, link4_btn_text_decoration, link_target4, link_txt4, link5, link5_btn_background, 
                      link5_btn_text_font_size, link5_btn_text_font_color, link5_btn_text_font_family, link5_btn_text_font_weight, link5_btn_text_decoration, link_target5, link_txt5, link6, 
                      link6_btn_background, link6_btn_text_font_size, link6_btn_text_font_color, link6_btn_text_font_family, link6_btn_text_font_weight, link6_btn_text_decoration, link_target6, 
                      link_txt6, link_font_color, link_font_family, link_font_size, link_font_weight, link_decoration, active, hierarchy
		FROM    Variable_Template_Dealer_Text
			...
			<div class="container pad-top-10">
				<cfloop query="gt_text" >
					<cfif #gt_text.title# NEQ "" >
						...
						<div class="row">
							<div class="col-md-12 pad-top-10 visible-sm visible-xs visible-lg visible-md" style="align:left">
					...
					<div class="row">
						...
						<div class="col-md-12 pad-top-10 visible-sm visible-xs visible-lg visible-md" style="align:left">
							<cfif #url.dealer_id# eq 256 and #pg_nbr# eq 7>
								#preservesinglequotes(gt_text.page_text)#
							<cfelse>
					...
					<cfif #gt_text.link1# NEQ "" >
							...
							<div class="row">
								<div class="col-md-12 pad-top-10 visible-sm visible-xs visible-lg visible-md" style="align:center">
							<cfif #gt_text.link1# NEQ "" >
							...
							<cfif #gt_text.link2# NEQ "" >
								...
								<!--- <div class="col-md-2 pad-top-10 visible-sm visible-xs visible-lg visible-md" style="align:left"> --->
