<cfcomponent>
	...
	<cfloop  query="Get_Layout" >
		...
		<cfset section_seq[b] = "#Get_Layout.module_name#" >
			...
			<cfif #Get_Layout.has_subs# EQ 1 and #Get_Layout.module_ID# EQ 1 OR #Get_Layout.module_ID# EQ 49  OR #Get_Layout.module_ID# EQ 78  OR #Get_Layout.module_ID# EQ 83 >
			...
			<cfif #Get_Layout.module_ID# EQ 14 or #Get_Layout.module_ID# EQ 80 >
			...
			<cfif #Get_Layout.module_ID# EQ 56 >
				<cfset sub_sec_bxslider_1_active = #Get_Layout.variable_spl1# >		<!--- Box slider on / off --->
				<cfset sub_sec_flippers_2_active = #Get_Layout.variable_spl2# >		<!--- Flip cardds on / off --->
			</cfif>	
