...
<cfset wireframe_f = "#gtxt6.wireframe_status#" >


<style type="text/css">

.f-section_multi{  height:<cfoutput>#gtxt6.section_height#</cfoutput>!important;   background: url('<cfoutput>#gtxt6.background_image#</cfoutput>') no-repeat center top; -webkit-background-size: cover;  -moz-background-size: cover;  -o-background-size: cover;
	 			background-size: cover; background-color: <cfoutput>###gtxt6.background_color#</cfoutput>!important; border:<cfoutput>#wireframe_f#</cfoutput>; }
.f-main-ic { 	width:	<cfoutput>#gtxt6.main_ic_width#</cfoutput>; margin-top: 	<cfoutput>#gtxt6.main_ic_pad_top#</cfoutput>; margin-left: 	<cfoutput>#gtxt6.main_ic_pad_left#</cfoutput>;
			margin-right: 	<cfoutput>#gtxt6.main_ic_pad_right#</cfoutput>; margin-bottom: 	<cfoutput>#gtxt6.main_ic_pad_bottom#</cfoutput>;float:left;  border:<cfoutput>#wireframe_f#</cfoutput>; }
.f-left-block { 	 width:<cfoutput>#gtxt6.split_box1_width#</cfoutput>!important; margin-top:<cfoutput>#gtxt6.split_box1_top_pad#</cfoutput>!important; margin-left:<cfoutput>#gtxt6.split_box1_top_left_pad#</cfoutput>;
				margin-right: 	<cfoutput>#gtxt6.split_box1_top_right_pad#</cfoutput>; margin-bottom: 	<cfoutput>#gtxt6.split_box1_top_bottom_pad#</cfoutput>!important; float:center!important;
				border:<cfoutput>#wireframe_d#</cfoutput>;  }
.f-left-title-block {   width:100%;border-left:<cfoutput>#gtxt3.split_box1_left_border#</cfoutput>;border-right:<cfoutput>#gtxt3.split_box1_right_border#</cfoutput>; 
						margin-bottom: <cfoutput>#gtxt3.split_box1_top_bottom_pad#</cfoutput>; }
				
.f-right-block { 	  width:	<cfoutput>#gtxt6.split_box2_width#</cfoutput>; margin-top: 	<cfoutput>#gtxt6.split_box2_top_pad#</cfoutput>; margin-left: <cfoutput>#gtxt6.split_box2_top_left_pad#</cfoutput>;
				...
				border:<cfoutput>#wireframe_d#</cfoutput>; }
.f-right-title-block {   width:100%;border-left:<cfoutput>#gtxt3.split_box2_left_border#</cfoutput>;border-right:<cfoutput>#gtxt3.split_box2_right_border#</cfoutput>; }

</style>

<cfif #gtxt6.recordcount# EQ 1 >
	<section class="f-section_multi">
				
		<div class="col-md-#nbr_cols# no-pad" >
			<cfif #gtxt6.split_box1_on# EQ 1 >
				<div class="f-left-block" >
					<div class="col-md-12  f-left-title-block " >
						 <center>#gtxt6.split_box1_title#</center>
					</div>	
				</div>
			</cfif>
		</div>
						...
						<div class="d-right-block" >
							...
							<cfif #d_right_buttons# EQ 1 >
								<cfloop query="gbtn6_right" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn6_right.button_destination#" target="#gbtn6_right.button_target#"  class="btn d-right-btn-spec-#gbtn6_right.currentrow#">#gbtn6_right.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
