			...
			<div class="container" >
			 	<div class="row">
					<div class="col-md-4 pad-top-10" align="left" >				 
						<img  alt="Logo" src="http://#cgi.server_name#/dealer/#variables.dlr_dir#/images/icons/logo.png" border="0" class="img-responsive"> 
					</div>
					<div class="col-md-3 pad-top-10" align="left" >				 
						<img alt="Header" src="http://#cgi.server_name#/dealer/#variables.dlr_dir#/images/icons/header-right.png" border="0" class="img-responsive"> 
					</div>
					<div class="col-md-5 no-pad" align="right" >				 
						...
						<span style="font-size:22pt;color:##000000;font-weight:bold">Phone:&nbsp;#Get_phones.Area_Code#.#Get_phones.Prefix#.#Get_phones.Line_Number#</span>
					</div>
				</div> 
			</div>
		</section>
					...
					<div class="row">
						<div class="row ">
							<div class="col-md-6" align="left" >	 
								...
								<div class="row pad-top-3"  style="background-color:##ffffff">
									<div class="col-md-12" align="left" >
  										 <iframe 	width="100%" 
										 			height="380" 
													<!---  src="http://www.youtube.com/embed/aY_II077YOM?rel=0&autoplay=1&controls=0showinfo=0&modestbranding=1"  changed 05/20/2015---> 
													src="http://www.youtube.com/embed/4sQYVQDMUAw?rel=0&autoplay=1&controls=0showinfo=0&modestbranding=1"
							...
							<div class="col-md-6  pad left 5" align="left"  >	
								...
								<span style="font-family:Helvetica-Condensed, sans-serif;font-size:10pt;color:##000000;font-weight:normal">&nbsp;Congratulations! Your pre-qualified* amount is valid at Aspen Hyundai. Securing funding prior to shopping gives you the purchasing power of a cash buyer and Aspen Hyundai has agreed to include all new and used vehicles in inventory for this special offer. So the selection is unlimited! Aspen Hyundai Management has also been authorized to accept purchase offers that meet your pre-qualification* amount. Please note, this offer will expire soon.
								</span>
								</div>
								</div>
