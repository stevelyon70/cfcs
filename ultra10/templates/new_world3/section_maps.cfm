		...
		<section class="section-maps">
			<div class="no-pad visible-md visible-lg ">
				...
				<div class="row">
					...
					<cfif #url.dealer_id# NEQ 311 AND  #url.dealer_id# NEQ 17  AND  #url.dealer_id# NEQ 365  AND  #url.dealer_id# NEQ 233 AND  #url.dealer_id# NEQ 32 AND  #url.dealer_id# NEQ 82>
						...
						><div class="row pad-bottom-05">
						 ...
						 <!--- <div class="row pad-bottom-05">&nbsp;</div  --->
							...
							<cfif #url.dealer_id# NEQ 17 AND  #url.dealer_id# NEQ 365  AND  #url.dealer_id# NEQ 233 AND  #url.dealer_id# NEQ 24 AND  #url.dealer_id# NEQ 82>
								<cfinvoke component="/cfcs/ultra10/var_nav_elements" method="query_var_location"> <!--- sorts by state & city --->
									...
									<cfif #url.dealer_id# EQ 32 >
										<cfset url.v_make = "Buick">
									</cfif>	
									<cfif #url.dealer_id# EQ 24 OR  #url.dealer_id# EQ 82 >
							...
							<cfelse>
							 <cfif  #url.dealer_id# EQ 233 or  #url.dealer_id# EQ 365>
                                ...
                                <a href="/dealership/hours_and_directions.cfm" ><img src="http://dealers.wdautos.com/dealer/kellynissan_bld/images/library/img_KellyNissan_Map.jpg" class="img-responsive" /></a>
								<!---<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3023.8681077490432!2d-75.29327348418698!3d40.720919879330964!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c46bcc6c18798b%3A0xfef9a375fc8a20cf!2sKelly+Nissan+of+Route+33!5e0!3m2!1sen!2sus!4v1456416973698" 
							...
							<cfif #url.dealer_id# EQ 369>
								<div class=" visible-md visible-lg">
									<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3056.8001178571044!2d-104.82445728420481!3d39.99057197941706!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x876c6d3809cedf67%3A0xf822c37d18f6e9e4!2s210+Great+Western+Rd%2C+Brighton%2C+CO+80601!5e0!3m2!1sen!2sus!4v1453927184969" 
