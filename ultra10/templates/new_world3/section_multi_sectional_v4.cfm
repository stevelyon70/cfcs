					...
					<div class="d-left-block no-pad">
						...
						<cfif #d_left_buttons# EQ 1 >
							<cfloop query="gbtn4_left" >
								...
								<div class="row">
									<div class="col-md-12 ">
										 <a href="#gbtn4_left.button_destination#" target="#gbtn4_left.button_target#"  class="btn d-left-btn-spec-#gbtn4_left.currentrow#">#gbtn4_left.button_text#</a>
									</div>	
								</div>
							</cfloop>
						</cfif>
			...
			<div class="col-md-#nbr_cols_right# no-pad">
				<cfif #gtxt4.split_box2_on# EQ 1 >
					<div class="d-right-block   no-pad" >
						<div class="col-md-12  d-right-title-block baierl-divider-text-big" >
