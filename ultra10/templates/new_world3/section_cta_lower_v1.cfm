...
<!--- LOWER CTA Variation 1 --->
	...
	<cfif #Get_Block4.recordcount# NEQ 0 >
				...
				<div class="row pad-bottom-10">
					<div class="col-md-6  visible-sm visible-xs  visible-lg visible-md" style="align:center">
						<cfloop index="x" from="1" to="2">
							<div class="row pad-top-10" style="margin-bottom:20px!important;min-height:40px;align:center">
		...
		<!--- TEMPORARY UNTIL SITE GOES LIVE --->					
								<!--- <iframe width="450" height="280" src="//www.youtube.com/embed/videoseries?list=PLChOW8lu1vx25UWMSYwsEhSY-QOkcSmLE" showinfo="0" controls="0" frameborder="0" allowfullscreen></iframe> --->
								<iframe width="450" height="280" src="https://www.youtube.com/embed/NeQc4XM7N_g?list=PLdyzuNEAeh2GOFENt4GsnmYYeMdJDyoLs" showinfo="0" controls="0" frameborder="0" allowfullscreen></iframe>
