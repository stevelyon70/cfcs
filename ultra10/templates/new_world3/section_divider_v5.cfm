...
<style type="text/css">
.d5-section_multi{  height:<cfoutput><cfif #dtxt4.section_height# NEQ "" >#dtxt4.section_height#</cfif></cfoutput>!important; background: url('<cfoutput>#dtxt5.background_image#</cfoutput>') no-repeat center top; -webkit-background-size: cover;  -moz-background-size: cover;  -o-background-size: cover;
	 			background-size: cover; background-color: <cfoutput>###dtxt5.background_color#</cfoutput>; border:<cfoutput>#wireframe_d5#</cfoutput>; }
...
.d5-right-title-block {   width:100%;border-left:<cfoutput>#dtxt5.split_box2_left_border#</cfoutput>;border-right:<cfoutput>#dtxt5.split_box2_right_border#</cfoutput>; }
	...
	@media (max-width: 600px) {
		.d5-section_multi{ /* min-height: 30px!important; */  height: auto!important; background-color: <cfoutput>###dtxt5.background_color#</cfoutput>!important;}
		.d5-main-ic {  ;	width:	100%!important;height: 100%!important; margin-left: 2px!important;	margin-right: 0px!important; margin-bottom:3px!important;float:center!important; 
							background-color:<cfoutput>###dtxt5.background_color#</cfoutput>!important; }
		.d5-left-block {   width:90%!important;  margin-left:3px; float:center!important;  }
		.d5-left-title-block {   width:100%!important; }
		.d5-right-block {   width:90%!important;  margin-left:3px; float:right!important;  }
		.d5-right-title-block {   width:100%!important; }
	} /* end 600 */
