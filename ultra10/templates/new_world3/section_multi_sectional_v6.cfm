...
<cfif #gtxt6.split_box2_on# EQ 1 >
	...
	<cfif #gbtn6_right.recordcount# NEQ 0 ><cfset d_right_buttons = 1 ><cfset r_btn_cnt = 1 > 
		<cfloop query="gbtn6_right" >
			<cfif #r_btn_cnt# EQ 1 >
				<style type="text/css">
					.f-right-btn-spec{ min-width:<cfoutput>#gbtn6_right.button_size_width#</cfoutput>!important; height:<cfoutput>#gbtn6_right.button_size_height#</cfoutput>!important; 
...
.f-section_multi{ /* height:<cfoutput>#gtxt6.section_height#</cfoutput>; */  background: url('<cfoutput>#gtxt6.background_image#</cfoutput>') no-repeat center top; -webkit-background-size: cover;  -moz-background-size: cover;  -o-background-size: cover;
...
.f-left-block { 	 width:<cfoutput>#gtxt6.split_box1_width#</cfoutput>; margin-top:<cfoutput>#gtxt6.split_box1_top_pad#</cfoutput>; margin-left:<cfoutput>#gtxt6.split_box1_top_left_pad#</cfoutput>;
...
.f-left-title-block {   width:100%;border-left:<cfoutput>#gtxt6.split_box1_left_border#</cfoutput>;border-right:<cfoutput>#gtxt6.split_box1_right_border#</cfoutput>; 
						margin-bottom: <cfoutput>#gtxt6.split_box1_top_bottom_pad#</cfoutput>; }
...
.f-right-block { 	  width:	<cfoutput>#gtxt6.split_box2_width#</cfoutput>; margin-top: 	<cfoutput>#gtxt6.split_box2_top_pad#</cfoutput>; margin-left: <cfoutput>#gtxt6.split_box2_top_left_pad#</cfoutput>;
				...
				border:<cfoutput>#wireframe_d#</cfoutput>; }
.f-right-title-block {   width:100%;border-left:<cfoutput>#gtxt6.split_box2_left_border#</cfoutput>;border-right:<cfoutput>#gtxt6.split_box2_right_border#</cfoutput>; }
						...
						<div class="d-left-block" >
							...
							<cfif #d_left_buttons# EQ 1 >
								<cfloop query="gbtn6_left" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn6_left.button_destination#" target="#gbtn6_left.button_target#"  class="btn f-left-btn-spec-#gbtn6_left.currentrow#">#gbtn6_left.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
						...
						<div class="d-right-block" >
							...
							<cfif #d_right_buttons# EQ 1 >
								<cfloop query="gbtn6_right" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn6_right.button_destination#" target="#gbtn6_right.button_target#"  class="btn f-right-btn-spec-#gbtn6_right.currentrow#">#gbtn6_right.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
