...
.b-section_multi{   min-height:<cfoutput>#gtxt2.section_height#</cfoutput>;   background: url('<cfoutput>#gtxt2.background_image#</cfoutput>') no-repeat center top; -webkit-background-size: cover;  -moz-background-size: cover;  -o-background-size: cover;
...
.b-right-title-block {   width:100%;border-left:<cfoutput>#gtxt2.split_box2_left_border#</cfoutput>;border-right:<cfoutput>#gtxt2.split_box2_right_border#</cfoutput>; }
	...
	@media (max-width: 600px) {
		...
		.b-main-ic {  ;	width:	100%!important;height: auto!important; margin-left: 2px!important;	margin-right: 0px!important; margin-bottom:3px!important;float:center!important; 
				...
				<div class="col-md-#nbr_cols# no-pad" >
					<cfif #gtxt2.split_box1_on# EQ 1 >
						<div class="b-left-block" >
							<div class="col-md-12 b-left-title-block divider-text" >		<!--- divider-text in Baierl Service  --->
							...
							<cfif #b_left_buttons# EQ 1 >
								<cfloop query="gbtn2_left" >
									...
									.b-left-btn-spec-#gbtn2_left.currentrow# { 
										...
										margin-bottom: <cfoutput>#gbtn2_left.space_bt_btns#</cfoutput>!important; margin-left:<cfoutput>#gbtn2_left.button_margin_left#</cfoutput>!important;
										padding:<cfoutput>#gbtn2_left.button_padding#</cfoutput>!important;}
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn2_left.button_destination#" target="#gbtn2_left.button_target#"  class="btn b-left-btn-spec-#gbtn2_left.currentrow#">#gbtn2_left.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
