...
.cta-button {
	...
	color:#ffffff!important;							/*  DB Feed */
	font-family:Arial;
	font-size:15px;
	font-weight:bold;
	font-style:normal;
...
.flip-container:hover .front, .flip-container.hover .front {
    ...
    transform: rotateY(180deg);
		...
		.back {
			background: transparent!important;							/*  DB Feed #cccccc */
...
<cfquery name="gt_bg_image" datasource="Ultra10">
	SELECT	a.CTA_image, b.dealer_directory
	FROM    Dealer_CTA_Titles a, Dealers b
...
<cfset bk_image = "#gt_bg_image.CTA_image#" >

<style type="text/css">
.section-combo{
	 background: url('http://ultra10.wddemos.com/dealer/<cfoutput>#gt_bg_image.dealer_directory#</cfoutput>/images/icons/<cfoutput>#bk_image#</cfoutput>') no-repeat center top;
...
<div class="section-80-percent  visible-lg visible-md ">		<!--- NEW 10/30/2015 --->
 <cfif #sub_sec_bxslider_1_active# eq 1 >
			<div class="container pad-top-10 ">
				...
				<div class="row-centered ">
					...
					<div class="row-centered"><div class="col-centered pad-top 5px  "><div class="page-div"></div>		
					</div>
						<div id="#arguments.assets#-spl-carousel" class="pad-top-10">
								...
								<cfinvokeargument name="slideWidth" value="350"/>
								<cfinvokeargument name="slideMargin" value="6"/>
...
<div class="section-100-percent  visible-sm visible-xs ">		<!--- NEW 10/30/2015 --->
 <cfif #sub_sec_bxslider_1_active# eq 1 >
			<div class="container pad-top-10 ">
					<cfquery name="gt_features" datasource="Ultra10">
						SELECT	CTA_Title_1, ft_size, ft_color, ft_weight, txt_align, 
				...
				<div class="row-centered ">
					<div class="col-centered pad-10">
						...
						<div class="row"><div class="col-md-12  visible-sm visible-xs"><div class="gradient"></div></div></div>	
					<div class="row-centered"><div class="col-centered pad-top 5px  "><div class="page-div"></div>		
					</div>
						<div id="#arguments.assets#-spl-carousel" class="pad-top-10">
								<cfinvoke component="/cfcs/ultra10/bxslider" method="v_rand">
