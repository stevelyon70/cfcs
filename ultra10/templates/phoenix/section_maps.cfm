...
<div container-fluid >
		<section class="section-maps">
			<div class="pad-top-10 visible-md visible-lg ">
				...
				<div class="row">
					...
					<cfif #url.dealer_id# NEQ 311 AND  #url.dealer_id# NEQ 17  AND  #url.dealer_id# NEQ 233 AND  #url.dealer_id# NEQ 82>
						...
						<div class="row pad-bottom-05">
						 ...
						 <!--- <div class="row pad-bottom-05">&nbsp;</div  --->
							...
							<cfif #url.dealer_id# NEQ 17 AND  #url.dealer_id# NEQ 233 AND  #url.dealer_id# NEQ 24 AND  #url.dealer_id# NEQ 82>
