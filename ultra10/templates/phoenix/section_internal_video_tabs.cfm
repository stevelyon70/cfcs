<cfoutput>
	...
	<cfquery datasource="Ultra10" name="get_content">
		...
		<cfif IsDefined("url.v_make") and #url.v_make# NEQ "" >
			...
			AND		page_type = 4
		<cfelseif #url.dealer_id# eq 233 or  #url.dealer_id# eq 24   or  #url.dealer_id# EQ 82   >	
			AND page_type = 0
		<cfelse>	
			AND page_type = 8
		</cfif>
				...
				<div class="row"><div class="col-md-12 pad-top-10 visible-sm visible-xs visible-lg visible-md"><div class="gradient"></div></div></div>	
					<div class="row">
						<cfif #get_content.Video_position# EQ 0 >
							...
							<div class="col-md-4 pad-top-10 pad-5">
								  <div class="row-centered">
								  	<div class="col-centered  pull-left pad-bottom-10  visible-lg visible-md">	  
						...
						<div class="col-md-6 pull-right ">
							...
							<div class="spl-search-name pad-top-10 pad-5  visible-lg visible-md visible-sm visible-xs " style="align:left"><span style="font-style:#tf_decor#;color:#tf_color#;font-size:#tf_size#;font-weight:#tf_weight#;font-family:#tf_familiy#">#get_content.Title#</span></div>
								<div class="row">
									...
									<div class="col-md-12 pad-top-5 pad-5  visible-lg visible-md visible-sm visible-xs ">
								 ...
								 <div class="row">
									<div class="col-md-12 pad-top-5 pad-bottom-10  visible-lg visible-md visible-sm visible-xs ">
