		...
		<section class="section-splash-spl">
			<div class="container">		
				...
				<div class="row pad-top-10">	
					...
					<cfif #url.dealer_id# eq 14 or  #url.dealer_id# eq 1  or  #url.dealer_id# eq 8 or  #url.dealer_id# eq 3 or  #url.dealer_id# eq 4 or  #url.dealer_id# eq 6 or  #url.dealer_id# eq 7 or  #url.dealer_id# eq 12 >
					<!--- new --->
						...
						<cfif #gt_search.recordcount# NEQ 0 >
							<cfloop query="gt_search">
								...
								<div class="col-md-12   visible-sm visible-xs visible-lg visible-md" align="#ln_1_align#">
				...
				<cfelse>		
						...
						<div class="row">  
						<cfif #gt_search.recordcount# NEQ 0 >
							<div class="col-md-12 pad-top-10 brands-title visible-sm visible-xs visible-lg visible-md" align="#ln_1_align#">
							<span style="#ln_1_style#">#gt_search.CTA_Title_1#</span>
						...
						<cfloop query="Get_Assigned_OEMs" >
							<div class="col-md-#nbr_col# pad-left 10px" align="center">
								 <cfif  #len(Get_Assigned_OEMs.Logo)# gt 0 >
								 	<a href="#Get_Assigned_OEMs.link_to#" target="_blank"><img alt="#gt_brands.CTA_Title_1#" src="http://dealers.wdautos.com//images/brand_logos/#Get_Assigned_OEMs.Logo#" class="img-responsive" ></a>
								 <cfelse>
