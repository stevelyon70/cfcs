<cfcomponent>
	...
	<cffunction name="page_build" description="builds the splash page" output="Yes" access="public">
		...
		<cfinvoke component="/cfcs/ultra10/templates/#url.template_id#/content_thankyou" method="#url.site_mode#">
			...
			<cfinvokeargument name="dealercode_id" value="#url.dealercode_id#"/>
