			...
			<div class="container int-container">
				...
				<cfswitch expression="#arguments.display_type#">
					...
					<cfdefaultcase>
						...
						<cfif #Get_Meta_Info.incl_position_1# eq 1 and #Get_Meta_Info.incl_dept_1# NEQ "" >
							<div class="row">
								<div class="col-md-12">
									<cfset url.staff_dept = #Get_Meta_Info.incl_dept_1# >
									<cfinvoke component="/cfcs/ultra10/staff_potf" method="#url.site_mode#_standard">
						...
						<cfif #Get_Meta_Info.incl_position_2# eq 1 >
							<div class="row">
								<div class="col-md-12">
