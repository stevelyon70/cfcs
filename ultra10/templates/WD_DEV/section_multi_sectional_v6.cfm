						...
						<div class="d-left-block" >
							...
							<cfif #d_left_buttons# EQ 1 >
								<cfloop query="gbtn6_left" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn6_left.button_destination#" class="btn d-left-btn-spec-#gbtn6_left.currentrow#"><cfif #gbtn6_left.glyph_on# EQ 2><span class="glyphicon glyphicon-chevron-right"></span></cfif>#gbtn6_left.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
						...
						<div class="d-right-block" >
							...
							<cfif #d_right_buttons# EQ 1 >
								<cfloop query="gbtn6_right" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn6_right.button_destination#" class="btn d-right-btn-spec-#gbtn6_right.currentrow#"><cfif #gbtn6_right.glyph_on# EQ 2><span class="glyphicon glyphicon-chevron-left"></span></cfif>#gbtn6_right.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
