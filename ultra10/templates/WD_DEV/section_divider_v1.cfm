...
<style type="text/css">
.d1-section_multi{  height:<cfoutput>#dtxt1.section_height#</cfoutput>; background: url('<cfoutput>#dtxt1.background_image#</cfoutput>') no-repeat center top; -webkit-background-size: cover;  -moz-background-size: cover;  -o-background-size: cover;
	 			background-size: cover; background-color: <cfoutput>###dtxt1.background_color#</cfoutput>; border:<cfoutput>#wireframe_d1#</cfoutput>; }
...
<!--- Splash Banners --->
	...
	<cfif #Chk_Splash_v1.recordcount# NEQ 0  OR  #dtxt1.recordcount# NEQ 0 >
		<div container-fluid >
			<section class="d1-section_multi">
