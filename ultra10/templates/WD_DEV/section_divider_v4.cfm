...
<style type="text/css">
.d4-section_multi{  height:<cfoutput>#dtxt4.section_height#</cfoutput>; background: url('<cfoutput>#dtxt4.background_image#</cfoutput>') no-repeat center top; -webkit-background-size: cover;  -moz-background-size: cover;  -o-background-size: cover;
	 			background-size: cover; background-color: <cfoutput>###dtxt4.background_color#</cfoutput>; border:<cfoutput>#wireframe_d3#</cfoutput>; }
...
<!--- Splash Banners --->
	...
	<cfif #Chk_Splash_v4.recordcount# NEQ 0 OR  #dtxt4.recordcount# NEQ 0 >
		<div container-fluid >
			<section class="d4-section_multi">
					...
					<cfif #dtxt4.recordcount# NEQ 0	>
						<cfif #dtxt4.split_box1_on# EQ 1 >
							<div class="row  row-centered">
								<div class="d4-left-block" >
									<div class="col-md-12 d4-left-title-block" >
