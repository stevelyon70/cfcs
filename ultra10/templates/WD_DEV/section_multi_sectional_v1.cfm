...
<style type="text/css">
	...
	.a-section_multi{  	height:<cfoutput>#gtxt.section_height#</cfoutput>!important;min-height:<cfoutput>#gtxt.section_height#</cfoutput>!important; 
						background: url('<cfoutput>#gtxt.background_image#</cfoutput>') no-repeat center top; -webkit-background-size: cover;  -moz-background-size: cover;  -o-background-size: cover;
		 				background-size: cover; background-color: <cfoutput>###gtxt.background_color#</cfoutput>; border:<cfoutput>#wireframe_a#</cfoutput>; }
	.main-ic {  height:100%!important;	width:	<cfoutput>#gtxt.main_ic_width#</cfoutput>; margin-top: 	<cfoutput>#gtxt.main_ic_pad_top#</cfoutput>; margin-left: 	<cfoutput>#gtxt.main_ic_pad_left#</cfoutput>;
	...
	@media (max-width: 600px) {
		.a-section_multi{  min-height: <cfoutput>#mbl_hght#</cfoutput>!important; }
		.main-ic {  ;	width:	100%!important;height: 100%!important; margin-left: 2px!important;	margin-right: 0px!important; margin-bottom:3px!important;float:center!important; background-color:##666666!important; }
					...
					<cfif #left_buttons# EQ 1 >
						<cfloop query="gbtn_left" >
							<style type="text/css">
								...
								@media (max-width: 600px) {
									.a-left-btn-spec-#gbtn_left.currentrow# { 
										min-width:90%!important;height:50px!important;text-align:center!important;font-size:18pt!important;margin-bottom:10px!important;margin-left:0px!important;padding:2px 2px 2px 2px!important;float:center!important;}
								}
