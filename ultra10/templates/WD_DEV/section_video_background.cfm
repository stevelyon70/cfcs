...
<div class="container-fluid">				
	<div class="clouds">	
        ...
        <video loop #spkr# autoplay width="1900"  >
            ...
            <source id="ogv" src="#ogg_vid#" type="http://leongaban.com/video/ogg"/>
 		...
 		<div class="video-float-block" >
			 <div class="video-float-title">
			 	<img img-responsive alt="Sample Banner" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/explorer_vans.jpg" />
			 </div> 
			<!---  <div class="video-float-text"  align="center" ></div>  --->
		</div>
		
 		<div class="video-float-banner" >
			<div class="video-float-banner-title"  align="center" >
			 	<img img-responsive alt="Sample Banner" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/sample_banner.jpg" />
			</div> 
			<!---  <div class="video-float-banner-text"  align="center" ></div>  --->
		</div>
