...
<div class="container-fluid" >
			<section class="section-cta-upper no-pad">
				...
				<div class="row"><div class="col-md-12 pad-top-10 visible-sm visible-xs visible-lg visible-md"><div class="page-divider"></div></div></div>	
					...
					<div class="row pad-bottom-10" style="min-height:400px">
						<cfloop index="x" from="1" to="#maxblk#" >
						
						
<style>
	.quarter_1 { background-color: ###a_background_color[1]#; }
	.cta-upper-title-q1{ font-family:#a_title_font_family[1]#; font-size:#a_title_font_size[1]#; font-weight:#a_title_font_weight[1]#; color:###a_title_font_color[1]#!important;}
	.cta-upper-pgtxt-q1{ font-family:#a_free_text_font_family[1]#; font-size:#a_free_text_font_size[1]#; font-weight:#a_free_text_font_weight[1]#; color:###a_free_text_font_color[1]#!important; }
	.cta-upper-go-btn-q1{font-family:#a_button_font_family[1]#; background-color: ###a_button_background[1]#; border:#a_button_border[1]# ###a_button_border_color[1]#; border-color: ###a_button_border_color[1]#; 
						 color: ###a_button_font_color[1]#; font-family:#a_button_font_family[1]#;
						 font-size:#a_button_font_size[1]#; font-weight:#a_button_font_weight[1]#; }
	.cta-upper-go-btn-q1:hover{ font-family:#a_button_font_family[1]#; background-color: ###a_button_hover_background[1]#; color: ###a_button_hover_font_color[1]#!important; }

	.quarter_2 { background-color: ###a_background_color[2]#; }
	.cta-upper-title-q2{ font-family:#a_title_font_family[2]#; font-size:#a_title_font_size[2]#; font-weight:#a_title_font_weight[2]#; color:###a_title_font_color[2]#!important;}
	.cta-upper-pgtxt-q2{ font-family:#a_free_text_font_family[2]#; font-size:#a_free_text_font_size[2]#; font-weight:#a_free_text_font_weight[2]#; color:###a_free_text_font_color[2]#!important; }
	.cta-upper-go-btn-q2{font-family:#a_button_font_family[2]#; background-color: ###a_button_background[2]#; border:#a_button_border[2]# ###a_button_border_color[2]#; border-color: ###a_button_border_color[2]#; 
						 color: ###a_button_font_color[2]#; font-family:#a_button_font_family[2]#;
						 font-size:#a_button_font_size[2]#; font-weight:#a_button_font_weight[2]#; }
	.cta-upper-go-btn-q2:hover{ font-family:#a_button_font_family[2]#; background-color: ###a_button_hover_background[2]#; color: ###a_button_hover_font_color[2]#!important; }
	...
	.cta-upper-go-btn-q3{font-family:#a_button_font_family[3]#; background-color: ###a_button_background[3]#; border:#a_button_border[3]# ###a_button_border_color[3]#; border-color: ###a_button_border_color[3]#; 
						 color: ###a_button_font_color[3]#; font-family:#a_button_font_family[3]#;
						 font-size:#a_button_font_size[3]#; font-weight:#a_button_font_weight[3]#; }
	.cta-upper-go-btn-q3:hover{ font-family:#a_button_font_family[3]#; background-color: ###a_button_hover_background[3]#; color: ###a_button_hover_font_color[3]#!important; }
	...
	.cta-upper-go-btn-q4:hover{ font-family:#a_button_font_family[4]#; background-color: ###a_button_hover_background[4]#; color: ###a_button_hover_font_color[4]#!important; }
							...
							<div class="col-md-3 pad-top-5 quarter_#x# " align="center">
								...
								<cfif #x# EQ 3 >
									<div class="row  pad-top-10 cta-upper-pgtxt-q3" >
										 <a href="#a_button_link[x]#" target="#a_button_target[x]#" class="cta-upper-go-btn-q#x#">&nbsp;&nbsp;#a_button_text[x]#</a> 
									</div>									
								</cfif>
								<cfif #x# EQ 1 >
								
									<!--- <div class="row  cta-upper-pgtxt-q3" >
									<iframe width="100%" height="350px" src="https://wl.tireconnect.ca/tireconnect/index?dealer_id=3158&sa" frameborder="0" allowfullscreen></iframe>
									 
									</div>		 --->	
									
									  <div class="row   cta-upper-pgtxt-q1" >
										<ul class="nav nav-tabs spl-tabs">
											<li class="active"><a href="##srch" data-toggle="tab">Search By Vehicle</a></li>
											<li><a href="##qq" data-toggle="tab" >Contact Us</a></li>
										</ul>
										<div class="tab-content srch-tabs">
											<div class="tab-pane active" id="srch">
												<cfinvoke component="/cfcs/ultra10/tool_search_engine" method="vertical_search_tire">
											...
											<div class="tab-pane" id="qq">
												<cfinvoke component="/cfcs/ultra10/tool_search_engine" method="vertical_tire">
													<cfinvokeargument name="dealer_id" value="#arguments.dealer_id#"/>
													<cfinvokeargument name="btn_pull" value="none"/>
