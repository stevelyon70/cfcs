		...
		<section class="section-maps">
			<div class="no-pad visible-md visible-lg ">
				...
				<div class="row">
					...
					<cfif #url.dealer_id# NEQ 311 AND  #url.dealer_id# NEQ 17  AND  #url.dealer_id# NEQ 365  AND  #url.dealer_id# NEQ 233 AND  #url.dealer_id# NEQ 82 AND  #url.dealer_id# NEQ 366>
						...
						<div class="row pad-bottom-05">
						 ...
						 <!--- <div class="row pad-bottom-05">&nbsp;</div  --->
							...
							<cfif #url.dealer_id# NEQ 17 AND  #url.dealer_id# NEQ 365  AND  #url.dealer_id# NEQ 233 AND  #url.dealer_id# NEQ 24 AND  #url.dealer_id# NEQ 82 AND  #url.dealer_id# NEQ 366>
							...
							<cfelse>
							 ...
							 <cfif  #url.dealer_id# EQ 366 >		<!--- Wright Vans Demo 01/08 --->
								<div class="col-centered visible-md visible-lg">
									<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3028.514597331627!2d-80.05852938430698!3d40.6185320512647!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x883489831c376ec1%3A0x25979a603a01c0f8!2s11015+Perry+Hwy%2C+Wexford%2C+PA+15090!5e0!3m2!1sen!2sus!4v1452263285431" 
