	...
	<section class="section-search-box">
		...
		<br>
			<cfform action="../../search/index.cfm" method="post" name="news" style="margin:0px 0px 0px 0px" >
				...
				<input  class="site-srch-input"	 type="text" name="lookup"  id="searchbar" style="margin:0px 0px 0px 0px" value=""  placeholder="Search #get_dlr_name.display_name#" required >
			</cfform>
			<br>
				...
				newsText[0] = "New Conversion Vans";
				newsText[1] = "What are your hours";
				newsText[2] = "Where are you located"
