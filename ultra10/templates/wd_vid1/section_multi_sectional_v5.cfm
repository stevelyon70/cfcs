						...
						<div class="d-left-block" >
							...
							<cfif #d_left_buttons# EQ 1 >
								<cfloop query="gbtn5_left" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn5_left.button_destination#" class="btn d-left-btn-spec-#gbtn5_left.currentrow#">#gbtn5_left.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
						...
						<div class="d-right-block" >
							...
							<cfif #d_right_buttons# EQ 1 >
								<cfloop query="gbtn5_right" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn5_right.button_destination#" class="btn d-right-btn-spec-#gbtn5_right.currentrow#">#gbtn5_right.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
