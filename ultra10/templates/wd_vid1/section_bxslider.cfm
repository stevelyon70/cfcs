...
<div class="container-fluid">
		<section class="section-bxslider">
			<div class="container pad-top-10 visible-sm visible-xs  visible-md visible-lg ">
				...
				<div class="row-centered visible-lg visible-md visible-sm visible-xs ">
					...
					<div class="row-centered"><div class="col-centered pad-top 5px  visible-sm visible-xs visible-lg visible-md"><div class="page-div"></div></div>
						<div id="#arguments.assets#-spl-carousel" class="pad-top-10">                    
							<cfinvoke component="/cfcs/ultra10/bxslider" method="v_rand">
								...
								<cfinvokeargument name="maxSlides" value="6"/>
								<cfinvokeargument name="slideWidth" value="150"/>
