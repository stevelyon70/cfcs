...
.a-section_multi{    height:<cfoutput>#gtxt.section_height#</cfoutput>!important;   background: url('<cfoutput>#gtxt.background_image#</cfoutput>') no-repeat center top; -webkit-background-size: cover;  -moz-background-size: cover;  -o-background-size: cover;
...
.left-block {   width:<cfoutput>#gtxt.split_box1_width#</cfoutput>; margin-top:<cfoutput>#gtxt.split_box1_top_pad#</cfoutput>; margin-left:<cfoutput>#gtxt.split_box1_top_left_pad#</cfoutput>;
...
.right-title-block {   width:100%;border-left:<cfoutput>#gtxt.split_box2_left_border#</cfoutput>;border-right:<cfoutput>#gtxt.split_box2_right_border#</cfoutput>; }
	...
	@media (max-width: 600px) {
		<cfif url.dealer_id eq 366>
		  .a-section_multi{height:235px!important;background: url('http://dealers.wdautos.com/dealer/wrightconversionvans/images/library/bg_WrightConversionVans_600.jpg') no-repeat center top; -webkit-background-size: contain;  -moz-background-size: contain;  -o-background-size: contain; background-size: contain; background-color: <cfoutput>###gtxt.background_color#</cfoutput>; border:<cfoutput>#wireframe_a#</cfoutput>;}
		</cfif>
		/*.a-section_multi{      height: 250px!important;padding-top:10px!important; background-color: <cfoutput>###gtxt.background_color#</cfoutput>!important;   background-size: cover!important;  }*/
	...
	@media (max-width: 350px) {
		<cfif url.dealer_id eq 366>
		  .a-section_multi{height:135px!important;background: url('http://dealers.wdautos.com/dealer/wrightconversionvans/images/library/bg_WrightConversionVans_350.jpg') no-repeat center top; -webkit-background-size: contain;  -moz-background-size: contain;  -o-background-size: contain; background-size: contain; background-color: <cfoutput>###gtxt.background_color#</cfoutput>; border:<cfoutput>#wireframe_a#</cfoutput>;}
		</cfif>
		/*.a-section_multi{      height: 250px!important;padding-top:10px!important; background-color: <cfoutput>###gtxt.background_color#</cfoutput>!important;   background-size: cover!important;  }*/
		.main-ic {  width:	100%!important;height: 100%!important; margin-left: 2px!important;	margin-right: 0px!important; margin-bottom:3px!important;float:center!important; 
