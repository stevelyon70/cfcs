...
<cfquery datasource="Ultra10" name="hotlist">SELECT use_hotlist FROM Dealers WHERE Dealer_ID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#url.dealer_id#" maxlength="10"></cfquery>

<div class="container-fluid">		
		<section class="section-splash-spl  no-pad">
		
			<cfif #hotlist.use_hotlist# eq 1 >			<!--- Marketing Banner  01/18/2016 --->
...
<!--- End Sub 1 --->
				...
				<!--- Sub 2 Slideshow--->
				 <CFIF #spl2# EQ 1 >
					...
					<cfif #url.dealer_id# eq 82 >				<!---  style="border:1px solid red" --->
						<div class="no-pad" >
					<cfelse>
