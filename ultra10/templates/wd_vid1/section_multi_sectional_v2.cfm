						...
						<div class="b-left-block" >
							...
							<cfif #b_left_buttons# EQ 1 >
								<cfloop query="gbtn2_left" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn2_left.button_destination#" class="btn b-left-btn-spec-#gbtn2_left.currentrow#">#gbtn2_left.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
						...
						<div class="b-right-block" >
							...
							<cfif #b_right_buttons# EQ 1 >
								<cfloop query="gbtn2_right" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn2_right.button_destination#" class="btn b-right-btn-spec-#gbtn2_right.currentrow#">#gbtn2_right.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
