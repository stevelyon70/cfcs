						...
						<div class="c-left-block" >
							...
							<cfif #c_left_buttons# EQ 1 >
								<cfloop query="gbtn3_left" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn3_left.button_destination#" class="btn c-left-btn-spec-#gbtn3_left.currentrow#">#gbtn3_left.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
						...
						<div class="c-right-block" >
							...
							<cfif #c_right_buttons# EQ 1 >
								<cfloop query="gbtn3_right" >
									...
									<div class="row">
										<div class="col-md-12 ">
											 <a href="#gbtn3_right.button_destination#" class="btn c-right-btn-spec-#gbtn3_right.currentrow#">#gbtn3_right.button_text#</a>
										</div>	
									</div>
								</cfloop>
							</cfif>
