<cfcomponent>
    ...
    <header class="section-hdr">
	    <div id="header" class="container row-hdr visible-md visible-lg "></div>
    </header>
...
<!---	<script>
    ...
    <cfsavecontent variable="c1">
			...
			$header.load('global/loadtest.cfm?id=5000');
			$topNav.load('global/loadtest.cfm?id=7000');
			$content1.load('global/loadtest.cfm?id=10000');
			$content2.load('global/loadtest.cfm?id=3000');
			$content3.load('global/loadtest.cfm?id=15000');
	</cfsavecontent>		
...
<cfif #url.dealer_id# NEQ 198 AND  #url.dealer_id# NEQ 302  AND  #url.dealer_id# NEQ 336  AND  #url.dealer_id# NEQ 341  >
