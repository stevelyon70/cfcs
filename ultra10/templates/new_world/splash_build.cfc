...
<cfif #url.dealer_id# NEQ 198 AND  #url.dealer_id# NEQ 302  AND  #url.dealer_id# NEQ 336  AND  #url.dealer_id# NEQ 17 AND  #url.dealer_id# NEQ 343  AND  #url.dealer_id# NEQ 341 AND  #url.dealer_id# NEQ 24  >
...
<cfif (#url.dealer_id# EQ 17 AND  #cgi.server_name# EQ "12ultra10.wddemos.com") OR  (#url.dealer_id# EQ 343 AND  #cgi.server_name# EQ "4ultra10.wddemos.com")  OR  
			...
			(#url.dealer_id# EQ 24 AND  #cgi.server_name# EQ "16ultra10.wddemos.com") >
	...
	<cfif #url.dealer_id# NEQ 198 AND ( #url.dealer_id# NEQ 17 AND  #cgi.server_name# NEQ "12ultra10.wddemos.com" ) AND 
			( #url.dealer_id# NEQ 343 AND  #cgi.server_name# NEQ "4ultra10.wddemos.com" )  AND ( #url.dealer_id# NEQ 341 AND  #cgi.server_name# NEQ "14ultra10.wddemos.com" ) 
			  AND ( #url.dealer_id# NEQ 24 AND  #cgi.server_name# NEQ "16ultra10.wddemos.com" )>
		<cfif #disp_nav# EQ 1 >
	...
	<cfif #url.dealer_id# NEQ 198  AND  #url.dealer_id# NEQ 302    AND  #url.dealer_id# NEQ 296    AND  #url.dealer_id# NEQ 17   AND  #url.dealer_id# NEQ 341    AND  #url.dealer_id# NEQ 343   AND  #url.dealer_id# NEQ 24       >
	...
	<cfif #url.dealer_id# EQ 341 or  #url.dealer_id# EQ 343 or  #url.dealer_id# EQ 24>
