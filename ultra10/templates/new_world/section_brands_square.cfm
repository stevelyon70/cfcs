		 	...
		 	<div class="container-brands">
						<cfif #gt_brands.recordcount# NEQ 0 >
							<div class="row">
								...
								<div class="col-md-12 pad-top-10 brands-title visible-sm visible-xs" style="align:#ln_1_align#">
				...
				<div class="row row-centered">
					<div class=" col-centered" >
						...
						<cfloop query="Get_Assigned_OEMs" >
									 <cfif #whats_left# lt 7 AND #do_once# EQ 1 >
										<cfset off_set = 8 - #whats_left# >
										<cfset do_once = 0 >
									<cfelse>	<cfset off_set = 0 >
									</cfif>  
							<div class=" col-centered pad-top-10" style="margin-right:10px">
