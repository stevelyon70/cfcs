		...
		<section class="section-spl">
					 ...
					 <cfif #url.dealer_id# EQ 17 >
						...
						<cfif #Get_Assigned_OEMs.recordcount# NEQ 0>
							<div class="row pad-top-10  ">
									<div class="col-md-#nbr_col#  pad-top-10 pad-bottom-10"<!---  style="border:1px solid" ---> align="center">
									<ul>
			...
			<div class="container">
				<div class="row visible-md visible-lg">
					<div class="col-md-12  visible-md visible-lg" align="center">
						<cfinvoke component="/cfcs/ultra10/nav_elements" method="query">
							<cfinvokeargument name="Get_Nav" value="#Get_Nav#"/>
							<cfinvokeargument name="Get_Phones" value="#Get_Phones#"/>
								  									...
								  									#url.dealer_id# NEQ 76 AND
								  										#url.dealer_id# NEQ 180 AND
								  											#url.dealer_id# NEQ 88 AND
								  												#url.dealer_id# NEQ 87   >  <!--- Fuccillo Portal increase the number of featured vehicles to 3 and shrink the Special Offers box --->
					<div class="row">
						...
						<div class="col-md-7 pad-10">
							<div title="#arguments.dealer_name# FEATURED VEHICLES"><span class="spl-search-name">#arguments.dealer_name#</span> <span class="spl-search-title">FEATURED VEHICLES</span></div>
							  <div id="#arguments.assets#-spl-carousel" class="pad-top-10">    <!--- limited to 2 images --->
								<!---  <cfinvoke component="/cfcs/ultra10/bxslider" method="v_limited"> 
									...
									<cfinvokeargument name="maxSlides" value="2"/>
