<cfcomponent>
	...
	<cffunction name="modern_standard" description="shows standard dealer hours" output="Yes" access="public">
		...
		<cfquery datasource="Ultra10" name="Get_Locations">
			...
			ORDER BY 	Dealer_Locations.Hierarchy ASC
		</cfquery>
		
		<div class="row">
			<cfloop query="Get_Locations">
			
		<cfif #Get_Locations.location_ID# eq 339 or #Get_Locations.location_ID# eq 340 >
			<cfset arguments.show_primary_btn = "yes" >
			<cfset arguments.show_service = "No" >
			<cfset arguments.show_parts = "No" >
			<cfset arguments.show_nv = "No" >
		</cfif>
		
			
				<div class="col-md-4">
					<div class="#arguments.store_class#" title="#Get_Locations.Display_Name#">#Get_Locations.Display_Name#</div>
					<cfif #Get_Locations.location_id# EQ 44 OR  #Get_Locations.location_id# EQ 53  OR  #Get_Locations.location_id# EQ 262 ><div class="stoltz-loc-msg">A Division of Stoltz Motor Company</div></cfif>
					<cfif #Get_Locations.location_id# EQ 43 ><div class="stoltz-loc-msg"> &nbsp;</div></cfif>
					...
					<div class="#arguments.phone_class#">
						<cfif #Get_Locations.location_id# NEQ 70 >
								...
								<cfif arguments.show_primary eq "yes">
									<cfif #Get_Locations.location_ID# eq 339 or #Get_Locations.location_ID# eq 340 >
										<cfif len(trim(Vanity_Number)) gt 0>
											#Get_Locations.Vanity_Number#
										<cfelse>
											<span style="font-size:12pt!important">(#Get_Locations.area_code#) #Get_Locations.prefix#-#Get_Locations.line_number#</span><br/>
								...
								<cfif arguments.show_service eq "yes">
									...
									<cfelse>
										<cfif len(trim(service_area_code)) gt 0>
											<cfif #Get_Locations.location_id# NEQ 12 >
						...
						<cfif #Get_Locations.location_id# EQ 70 >
								(702) 566-2000<br/></cfif>
					</div>
					<cfif arguments.show_primary_btn eq "yes">
						<cfif #Get_Locations.location_ID# eq 339 >
						<a class="#arguments.service_btn_class#" href="http://kellynissanofroute33.com/used/" target="_blank" title="Visit KellyNissanofRoute33.com">#arguments.primary_label#</a>
						<cfelseif #Get_Locations.location_ID# eq 340 >
						<a class="#arguments.service_btn_class#" href="http://kellyriskfree.com/used" target="_blank" title="Visit kellyriskfree.com">#arguments.primary_label#</a>
						<cfelse>
				...
				<cfif arguments.Dealer_ID eq "162" or  arguments.Dealer_ID eq "341">
				...
				<cfif Get_Locations.currentRow mod 3 eq 0>
					</div><div class="row">
				</cfif>
			</cfloop>
		</div>
