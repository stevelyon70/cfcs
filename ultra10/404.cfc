		...
		<cfswitch expression="#arguments.my_page_type#">
			...
			<cfcase value="showroom">
				...
				<cfif Get_Model_Details.Recordcount gt 0 and len(trim(Get_Model_Details.Vehicle_Make)) gt 0>
					...
					<cfset variables.server_location="E:\inetpub\wwwroot\Ultra10\showroom">
					...
					<cfinvoke component="/cfcs/automation/site_depth" method="create_file">
						...
						<cfinvokeargument name="file_output" value='<cfset url.v_make="#Get_Model_Details.Vehicle_Make#"><cfinvoke component="/cfcs/ultra10/templates/##url.template_id##/page_build" method="page_build"><cfinvokeargument name="dealer_id" value="##url.dealer_id##"/><cfinvokeargument name="dealer_name" value="##url.dealer_name##"/><cfinvokeargument name="address_1" value="##url.address_1##"/><cfinvokeargument name="address_2" value="##url.address_2##"/><cfinvokeargument name="city" value="##url.city##"/><cfinvokeargument name="state" value="##url.state##"/><cfinvokeargument name="zip" value="##url.zip##"/><cfinvokeargument name="assets" value="##url.assets##"/><cfinvokeargument name="template_id" value="##url.template_id##"/><cfinvokeargument name="dealer_template_id" value="##url.dealer_template_id##"/><cfinvokeargument name="site_mode" value="##url.site_mode##"/><cfinvokeargument name="Get_Nav" value="##Get_Nav##"/><cfinvokeargument name="Get_Phones" value="##Get_Phones##"/><cfinvokeargument name="component_name" value="/cfcs/ultra10/chrome_reviews"/><cfinvokeargument name="method_name" value="##url.site_mode##_index"/><cfinvokeargument name="display_type" value="col_right"/><cfinvokeargument name="Get_Meta_Info" value="##Get_Meta_Info##"/></cfinvoke>'/>
					</cfinvoke>

					<cfinvoke component="/cfcs/automation/site_depth" method="create_file">
						<cfinvokeargument name="server_location" value="#variables.server_location#\#lcase(Get_Model_Details.Vehicle_Make)#"/>
						<cfinvokeargument name="file_name" value="#lcase(GetFileFromPath(cgi.CF_TEMPLATE_PATH))#"/>
						<cfinvokeargument name="file_output" value='<cfset url.chrome_model_id="#url.chrome_model_id#"><cfinvoke component="/cfcs/ultra10/templates/##url.template_id##/page_build" method="page_build"><cfinvokeargument name="dealer_id" value="##url.dealer_id##"/><cfinvokeargument name="dealer_name" value="##url.dealer_name##"/><cfinvokeargument name="address_1" value="##url.address_1##"/><cfinvokeargument name="address_2" value="##url.address_2##"/><cfinvokeargument name="city" value="##url.city##"/><cfinvokeargument name="state" value="##url.state##"/><cfinvokeargument name="zip" value="##url.zip##"/><cfinvokeargument name="assets" value="##url.assets##"/><cfinvokeargument name="template_id" value="##url.template_id##"/><cfinvokeargument name="dealer_template_id" value="##url.dealer_template_id##"/><cfinvokeargument name="site_mode" value="##url.site_mode##"/><cfinvokeargument name="Get_Nav" value="##Get_Nav##"/><cfinvokeargument name="Get_Phones" value="##Get_Phones##"/><cfinvokeargument name="component_name" value="/cfcs/ultra10/chrome_reviews"/><cfinvokeargument name="method_name" value="##url.site_mode##_review"/><cfinvokeargument name="display_type" value="col_right"/><cfinvokeargument name="Get_Meta_Info" value="##Get_Meta_Info##"/></cfinvoke>'/>
					</cfinvoke>
			...
			<cfcase value="v_details">
				<!---Get Vehicle Details--->
				<cfstoredproc datasource="Ultra10" procedure="Get_Vehicle_Details_Permalink">
				...
				<cfif 	len(trim(Get_Vehicle_Details.V_Make)) gt 0
					...
					<cfset variables.server_location="E:\inetpub\wwwroot\Ultra10\vehicles">
					...
					<cftry>
						...
						<cffile action="WRITE"
								...
								addnewline="No" 
								output='<cfset url.vin="#Get_Vehicle_Details.Vin#"><cfinvoke component="/cfcs/ultra10/templates/##url.template_id##/vdp_build" method="page_build"><cfinvokeargument name="dealer_id" value="##url.dealer_id##"/><cfinvokeargument name="dealer_name" value="##url.dealer_name##"/><cfinvokeargument name="address_1" value="##url.address_1##"/><cfinvokeargument name="address_2" value="##url.address_2##"/><cfinvokeargument name="city" value="##url.city##"/><cfinvokeargument name="state" value="##url.state##"/><cfinvokeargument name="zip" value="##url.zip##"/><cfinvokeargument name="assets" value="##url.assets##"/><cfinvokeargument name="template_id" value="##url.template_id##"/><cfinvokeargument name="dealer_template_id" value="##url.dealer_template_id##"/><cfinvokeargument name="site_mode" value="##url.site_mode##"/><cfinvokeargument name="Get_Nav" value="##Get_Nav##"/><cfinvokeargument name="Get_Phones" value="##Get_Phones##"/><cfinvokeargument name="Get_Vehicle_Details" value="##Get_Vehicle_Details##"/><cfinvokeargument name="Get_Meta_Info" value="##Get_Meta_Info##"/></cfinvoke>' 
								nameconflict="OVERWRITE">
						<cfcatch></cfcatch>
					</cftry>
				</cfif>
			...
			<cfcase value="blog">
				...
				<cfset variables.server_location="E:\inetpub\wwwroot\Ultra10\blog">
				
				<cfquery datasource="Ultra10" name="Get_Blog">
					...
					<cfif check_dir.recordcount eq 0>
						...
						<cftry>
							...
							<cffile action="WRITE" 
									...
									output='<cfset url.archive_date="#dateformat(Get_Blog.Date_Submitted,"mmmm")# #dateformat(Get_Blog.Date_Submitted,"yyyy")#"><cfinvoke component="/cfcs/ultra10/templates/##url.template_id##/page_build" method="page_build"><cfinvokeargument name="dealer_id" value="##url.dealer_id##"/><cfinvokeargument name="dealer_name" value="##url.dealer_name##"/><cfinvokeargument name="address_1" value="##url.address_1##"/><cfinvokeargument name="address_2" value="##url.address_2##"/><cfinvokeargument name="city" value="##url.city##"/><cfinvokeargument name="state" value="##url.state##"/><cfinvokeargument name="zip" value="##url.zip##"/><cfinvokeargument name="assets" value="##url.assets##"/><cfinvokeargument name="template_id" value="##url.template_id##"/><cfinvokeargument name="dealer_template_id" value="##url.dealer_template_id##"/><cfinvokeargument name="site_mode" value="##url.site_mode##"/><cfinvokeargument name="Get_Nav" value="##Get_Nav##"/><cfinvokeargument name="Get_Phones" value="##Get_Phones##"/><cfinvokeargument name="component_name" value="/cfcs/ultra10/blog"/><cfinvokeargument name="method_name" value="list_date"/><cfinvokeargument name="display_type" value="full"/><cfinvokeargument name="Get_Meta_Info" value="##Get_Meta_Info##"/></cfinvoke>'
									nameconflict="OVERWRITE"
									addnewline="No">
							<cfcatch></cfcatch>
						</cftry>
