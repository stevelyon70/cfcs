...
<cfquery datasource="Ultra10" name="Get_Classics">
		...
		<cfloop index="x" from="1" to="#a_Last#" step="#stepper#" >
			...
			<div class="row">
				...
				<cfif #a_Img_Urls[x]# NEQ "">  
					<img src="#listgetat(a_Img_Urls[x],1)#" class="img-responsive" alt="#a_V_Year[x]# #a_V_Make[x]# #a_V_Model[x]#"   >
			  	</cfif> 
			...
			<cfif #nxt# LTE #a_Last# >
				...
				<cfif #a_Img_Urls[nxt]# NEQ "">  
					<img src="#listgetat(a_Img_Urls[nxt],1)#" class="img-responsive" alt="#a_V_Year[nxt]# #a_V_Make[nxt]# #a_V_Model[nxt]#"   >
			  	</cfif>  
				<!--- <br> --->
				<div class="col-md-3"   align="center" style="font-size:8pt" >
				<a class="special-link" href="#variables.v_link#">Details</a>
