						...
						<form method="post" action="" name="calc">
							<div class="row">
								<div class="col-md-12 pad-bot-5" align="center">
									<b>Vehicle Price&nbsp;:&nbsp;</b>
									<input class="calc-input" type="text" name="price" id="price" maxlength="10" value="#url.price#" onChange="validateInput(this,calc)"  <cfif len(trim(url.price)) neq 0>onfocus="validateInput(this,calc)"</cfif>>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 pad-bot-5" align="center">
									<b><em>*</em> Interest Rate&nbsp;:&nbsp;</b>
									<input class="calc-input" type="text" name="rate" maxlength="5" size="5" onChange="validateInput(this,calc)" value="#variables.my_rate#">
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 pad-bot-5" align="center">
									...
									<cfif #url.dealer_id# NEQ 257>
										<input class="calc-input" type="text" name="down_payment" maxlength="10" size="10" value="0" onChange="validateInput(this,calc)">
									<cfelse>	
										<input class="calc-input" type="text" name="down_payment" maxlength="10" size="10" value="1999" onChange="validateInput(this,calc)">
									</cfif>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 pad-bot-5" align="center">
									<cfif #variables.nbr_btns# GT 0 >
										<input type="button" name="calcBtn"  onclick="doCalculate()" class="btn calulator-btn-cust" value="Calculate Monthly Payment">
									<cfelse>
							...
							<div class="row">
								<div class="col-md-6 pad-bot-5">
									<b>36 Months&nbsp;:&nbsp;</b><input class="calc-input" type="text" name="out_36" size="10" maxlength="10">
								</div>
								<div class="col-md-6 pad-bot-5">
									<b>48 Months&nbsp;:&nbsp;</b><input class="calc-input" type="text" name="out_48" size="10" maxlength="10">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 pad-bot-5">
									<b>60 Months&nbsp;:&nbsp;</b><input class="calc-input" type="text" name="out_60" size="10" maxlength="10">
								</div>
								<div class="col-md-6 pad-bot-5">
									<b>72 Months&nbsp;:&nbsp;</b><input class="calc-input" type="text" name="out_72" size="10" maxlength="10">
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-6 pad-bot-5">
									<b>84 Months&nbsp;:&nbsp;</b><input class="calc-input" type="text" name="out_84" size="10" maxlength="10">
								</div>
							</div>
						</form>
						<div class="row">
					...
					<div class="col-md-6">
						...
						<form name="calculatorform" mehtod="POST" action="JavaScript:paymentEvent()">
							<div class="row">
								...
								<div class="col-md-6 pad-bot-5">
									$<INPUT class="calc-input" TYPE="text" NAME="desired_monthly_payment" onChange="JavaScript:paymentEvent()">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 pad-bot-5">
								...
								<div class="col-md-6 pad-bot-5">
									&nbsp;&nbsp;<INPUT class="calc-input" TYPE="text" NAME="loan_rate" value="0" onChange="JavaScript:paymentEvent()">&nbsp;%
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 pad-bot-5">
								...
								<div class="col-md-6 pad-bot-5">
									&nbsp;&nbsp;<INPUT class="calc-input" TYPE="text" NAME="sales_tax" value="0" onChange="JavaScript:paymentEvent()">&nbsp;%
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 pad-bot-5">
								...
								<div class="col-md-6 pad-bot-5">
									&nbsp;&nbsp;<INPUT class="calc-input" TYPE="text" NAME="desired_term_length" value="48" onChange="JavaScript:paymentEvent()">&nbsp;months
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 pad-bot-5" align="center">
									<cfif #variables.nbr_btns# GT 0 >
										<input type="submit"     class="btn calulator-btn-cust" value="Calculate">
									<cfelse>
							...
							<div class="row">
								<div class="col-md-12 pad-bot-5">
									With a $<INPUT class="calc-input" TYPE="text" NAME="desired_monthly_payment_results"> per month payment
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 pad-bot-5">
									For <INPUT class="calc-input" TYPE="text" NAME="desired_term_length_results"> months,
								</div>
							</div>
							<div class="row">
								<div class="col-md-12 pad-bot-5">
									you can finance $<INPUT class="calc-input" TYPE="text" NAME="desired_finance_results">
								</div>
							</div>
						</form>
						<div class="row">
