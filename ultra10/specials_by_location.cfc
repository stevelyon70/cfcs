<cfcomponent>
	...
	<cffunction name="modern_standard" description="shows NEW/USED SPECIALS links by location" output="Yes" access="public">
		...
		<cfargument name="primary_label" default="New Car Specials">
		<cfargument name="show_service_btn" default="no">
		<cfargument name="show_parts_btn" default="no">
		<cfargument name="service_label" default="Used Car Specials">
		...
		<cfquery datasource="Ultra10" name="Get_Locations">
			SELECT		Dealer_Locations.Dealer_ID,
						...
						Dealers.Link_New_Specials,
						Dealers.Link_Used_Specials,
		...
		<div class="row">
			<cfloop query="Get_Locations">
				<div class="col-md-4">
					...
					<a class="#arguments.service_btn_class#" href="#Get_Locations.Link_New_Specials#" target="_blank" title="New Car Specials">#arguments.primary_label#</a> 
					<a class="#arguments.service_btn_class#" href="#Get_Locations.Link_Used_Specials#" target="_blank" title="Used Car Specials">#arguments.service_label#</a>
				</div>
