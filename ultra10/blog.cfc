<cfcomponent>
	...
	<cffunction name="list" description="shows default blog page" output="Yes" access="public">
		...
		<!---Get Blogs--->
<cfif arguments.dealer_id NEQ 256  ><!---AND  arguments.dealer_id NEQ 365--->
		<cfstoredproc datasource="Ultra10" procedure="Get_Blogs">
...
<cfif #url.dealer_id# EQ 256 >
		<cfquery name="Get_Blogs" datasource="Ultra10">
			SELECT		Dealer_Wordpress_ID,
						...
						Post_Tags, 
			            Perma_Link,
			            RIGHT(Date_Submitted, 4) AS Arc_Year
			...
			ORDER BY	Arc_Year DESC,
						Date_Submitted DESC,
						Time_Submitted DESC
		</cfquery>			
			
		
		<cfquery name="Get_Archives" datasource="Ultra10">
			SELECT DISTINCT LEFT(Date_Submitted, 2) AS Arc_Month, 
								RIGHT(Date_Submitted, 4) AS Arc_Year,
								Archive_Submitted
			FROM         	Dealer_Wordpress
			WHERE		Dealer_ID IN 
			...
			ORDER BY 		Arc_Year Desc, Arc_Month Desc
		</cfquery>			

		<cfquery name="Get_Tags" datasource="Ultra10">
			SELECT		WP_Tag,
						WP_Link
		...
		<cfquery name="Get_Recent" datasource="Ultra10">
			SELECT		TOP (8)
						Date_Submitted,
						Post_Title,
						Perma_Link,
...
<!---<cfif #url.dealer_id# EQ 365 >								 NEW Kelly Nissan TEMPORARY 
		<cfquery name="Get_Blogs" datasource="Ultra10">
			SELECT		Dealer_Wordpress_ID,
						Dealer_ID,
						Post_ID,
			...
			WHERE		Dealer_ID IN 
					(	SELECT 	Distinct Share_ID 
						FROM 	ultra10.dbo.Dealer_Shares 
						WHERE 	Dealer_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="18" maxlength="4">
					)
			ORDER BY	Arc_Year DESC,
						Date_Submitted DESC,
						Time_Submitted DESC
        ...
        <cfif variables.startRow lte 0>
        	<cfset variables.startRow = 1>
        </cfif>
        <cfif variables.endRow lte variables.startRow>
        	<cfset variables.endRow = variables.startRow>
        </cfif>
		...
		<div class="row">
			<div class="col-md-12  visible-md visible-lg">
				<cfinvoke component="/cfcs/ultra10/blog" method="pagination">
		...
		<div class="row">
			<div class="col-md-12 visible-xs visible-sm">
				<cfinvoke component="/cfcs/ultra10/blog" method="pagination_next">
					<cfinvokeargument name="Recordcount" value="#Get_Blogs.Recordcount#"/>
				</cfinvoke>
			</div>
		</div>
	...
	<cffunction name="single" description="shows a single blog page" output="Yes" access="public">
		...
		<cfif #arguments.dealer_id# EQ 365 >			<!--- Kelly Nissan TEMPORARY --->
			<!---<cfset arguments.dealer_id = 18 >--->
		</cfif>
		
		<!---Get Blogs--->
		<cfstoredproc datasource="Ultra10" procedure="Get_Blog_Post">
			<cfprocparam type="In" cfsqltype="CF_SQL_INTEGER" dbvarname="dealer_id" value="#arguments.dealer_id#" maxlength="10">
			...
			<cfprocresult name="Get_Tags" resultset="3">
			<cfprocresult name="Get_Recent" resultset="4">
			<cfprocresult name="Get_Categories" resultset="5">
		</cfstoredproc>
	...
	<cffunction name="list_date" description="shows default blog page" output="Yes" access="public">
		...
		<!---Get Blogs--->
<cfif #url.dealer_id# NEQ 256 >
		<cfstoredproc datasource="Ultra10" procedure="Get_Blogs_By_Date">
			<cfprocparam type="In" cfsqltype="CF_SQL_INTEGER" dbvarname="dealer_id" value="#arguments.dealer_id#" maxlength="10">
...
<cfif #url.dealer_id# EQ 256 >
		<cfquery name="Get_Blogs" datasource="Ultra10">
			...
			AND			Archive_Submitted = '#url.archive_date#'
			ORDER BY	Arc_Year DESC,
						Date_Submitted DESC,
						Time_Submitted DESC
		</cfquery>			
		...
		<!--- RE-Write the TITLE TAG  11/05/2015 --->	
				<cfquery name="Get_Dlr" datasource="Ultra10">
					SELECT    City, State
					FROM         Dealers
					WHERE dealer_id = #url.dealer_id#
				</cfquery>	
				<cf_resetpagetitle newTitle="ARCHIVE:#ucase(url.archive_date)# | #arguments.dealer_name# #Get_Dlr.City# #Get_Dlr.State#" />
		<!--- RE-Write the TITLE TAG  11/05/2015 --->	
		...
		<div class="row">
			<div class="col-md-9">
				<cfif #variables.startRow# LTE 0><cfset variables.startRow = 1></cfif>		<!--- bob 08/10/2015 --->
				<cfloop query="Get_Blogs" startrow="#variables.startRow#" endrow="#variables.endRow#">
					<div class="row blog-content">
						<div class="col-md-12">
							<div class="row">
	...
	<cffunction name="list_tag" description="shows default blog page" output="Yes" access="public">
		...
		<cfargument name="dealer_name" required="true">
		 ...
		 <cfquery datasource="Ultra10" name="Get_Blogs">
			SELECT		Dealer_Wordpress_ID,
						Dealer_ID,
						Post_ID,
						Date_Submitted,
		...
		<div class="row">
			<div class="col-md-12">
				<h1 class="site-h1" title="TAG ARCHIVES: #url.tag#">TAG ARCHIVES: #url.tag#</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12  visible-md visible-lg">
