<cfcomponent>
	...
	<cffunction name="modern" description="shows a standard header" output="Yes" access="public">
		...
		<div class="visible-lg visible-md no-pad pull-right" >
			<nav class="navbar section-nav navbar-default navbar-dt no-pad" >
							...
							<cfloop query="Get_Nav">
								...
								<!--- Mega Menu determiniation STARTS Here --->
									...
									<cfif #chk_4_mega.Mega_Menu# EQ 1>
										...
										<cfset variables.Mega_Glyph_Color="#chk_4_mega.Mega_Glyph_Color#!important">
		...
		<div class="visible-xs visible-sm" align="left">
			<nav class="navbar section-nav navbar-default navbar-dt pull-left" >
				...
				<div class="collapse navbar-collapse navbar-mbl-drop no-pad pull-left" align="left" id="mobile_nav" >
