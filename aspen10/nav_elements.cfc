...
<cfcomponent>
	...
	<cffunction name="query" description="shows nav driven by a query" output="Yes" access="public">
		...
		<!--- <cfoutput>#Get_Nav.recordcount# <cfabort></cfoutput> --->
				...
				<cfswitch expression="#Get_Nav.Nav_Behaviour_ID#">
					<cfcase value="1">
						<cfif len(trim(Get_Nav.Nav_Mobile_Link)) gt 0>
							...
							<cfelse>
								<cfif len(trim(Get_Nav.pull)) eq 0 and  len(trim(Get_Nav.Align)) neq 0><div align="#Get_Nav.Align#"></cfif>
								<a id="nav_#Get_Nav.Nav_ID#" class="#variables.element_class# visible-sm visible-xs" href="#Get_Nav.Nav_Mobile_Link#" title="#Get_Nav.Nav_Alt#">
									 <img style="#variables.element_style#"  class="#Get_Nav.Nav_ID#<cfif arguments.responsive eq "true"> img-responsive</cfif>" alt="#Get_Nav.Nav_Alt#" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#" border="0"/>
								</a>
						...
						<cfelse>
							<cfif len(trim(Get_Nav.Nav_Rollover)) eq 0>
								...
								<a id="nav_#Get_Nav.nav_id#"class="#variables.element_class# nav_#Get_Nav.Nav_ID#" href="#Get_Nav.Nav_Link#" title="#Get_Nav.Nav_Alt#">
									<img style="#variables.element_style#"  class="nav_#Get_Nav.Nav_ID#<cfif arguments.responsive eq "true"> img-responsive</cfif>" alt="#Get_Nav.Nav_Alt#" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#" border="0"/>
								</a>
								<cfif len(trim(Get_Nav.pull)) eq 0 and  len(trim(Get_Nav.Align)) neq 0></div></cfif>
							<cfelse>
								<cfif len(trim(Get_Nav.pull)) eq 0 and  len(trim(Get_Nav.Align)) neq 0><div align="#Get_Nav.Align#"></cfif>
					...
					<cfcase value="3">
						...
						<cfelse>
							<div id="nav_#Get_Nav.Nav_ID#" class="#variables.element_class# nav_#Get_Nav.Nav_ID#" title="#Get_Nav.Nav_Alt#" <cfif len(trim(Get_Nav.pull)) eq 0 and  len(trim(Get_Nav.Align)) neq 0>align="#Get_Nav.Align#"</cfif>>
								<img style="#variables.element_style#" class="#Get_Nav.Nav_ID# <cfif arguments.responsive eq "true"> img-responsive</cfif>" alt="#Get_Nav.Nav_Alt#" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#" border="0"/>
							</div>
						</cfif>					
					</cfcase>
						...
						<cfloop query="Get_Phones">
							<cfif Get_Phones.Phone_ID eq Get_Nav.Phone_ID>
								<cfif len(trim(Get_Phones.Vanity_Number)) gt 0>
									<div id="nav_#Get_Nav.Nav_ID#" style="#variables.element_style#" class="#variables.element_class# nav_#Get_Nav.Nav_ID#" title="#Get_Nav.Nav_Name# #Get_Phones.Vanity_Number#">#Get_Nav.Nav_Name# #Get_Phones.Vanity_Number#</div>
								<cfelse>
									<div id="nav_#Get_Nav.Nav_ID#" style="#variables.element_style#" class="#variables.element_class# nav_#Get_Nav.Nav_ID#" title="#Get_Nav.Nav_Name# (#Get_Phones.Area_Code#) #Get_Phones.Prefix#-#Get_Phones.Line_Number#">#Get_Nav.Nav_Name# (#Get_Phones.Area_Code#) #Get_Phones.Prefix#-#Get_Phones.Line_Number#</div>
								</cfif>
							</cfif>
						</cfloop>
					</cfcase>
					<cfcase value="10">
						<div id="nav_#Get_Nav.Nav_ID#" style="#variables.element_style#" class="#variables.element_class# nav_#Get_Nav.Nav_ID#" title="#arguments.address_1# #arguments.address_2# #arguments.city#, #arguments.state# #arguments.zip#">
							#arguments.address_1#<br/>
					...
					<cfcase value="11">
						<div id="nav_#Get_Nav.Nav_ID#" style="#variables.element_style#" class="#variables.element_class# nav_#Get_Nav.Nav_ID#" title="#arguments.address_1# #arguments.address_2# #arguments.city#, #arguments.state# #arguments.zip#">
							#arguments.address_1# | <cfif len(trim(arguments.address_2)) gt 0>#arguments.address_2# | </cfif>#arguments.city#, #arguments.state# #arguments.zip#
						</div>
					</cfcase>
					<cfcase value="12">
						...
						<cfswitch expression="#url.site_mode#">
							<cfdefaultcase>
								<a id="nav_#Get_Nav.nav_id#" class="#variables.element_class# nav_#Get_Nav.Nav_ID#"  title="#Get_Nav.Nav_Alt#" href="##" data-toggle="modal" data-target="##videoModal">
									<img class="nav_#Get_Nav.Nav_ID#<cfif arguments.responsive eq "true"> img-responsive</cfif>" alt="#Get_Nav.Nav_Alt#" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#" border="0"/>
								</a>
							</cfdefaultcase>
							<cfcase value="legacy">
					...
					<cfcase value="16">
						...
						<cfelse>
							<a href="http://#cgi.server_name#/special_offers/print_me.cfm?Nav_ID=#Get_Nav.Nav_ID#" id="nav_#Get_Nav.Nav_ID#" class="#variables.element_class# nav_#Get_Nav.Nav_ID# rollover" title="#Get_Nav.Nav_Alt#" target="_blank">
								<img class="#Get_Nav.Nav_ID#<cfif arguments.responsive eq "true"> img-responsive</cfif>" alt="#Get_Nav.Nav_Alt#" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#" border="0"/>
							</a>
						</cfif>
					</cfcase>
					<cfcase value="17">
						<cfif len(trim(Get_Nav.Nav_Link)) gt 0>
							...
							<div class="col-md-#arguments.colspan#" align="center">
...
<!--- Service Center Coupons --->
		...
		<cfloop query="Get_Nav">
			...
			<cfif Get_Nav.Nav_Type_ID eq arguments.nav_type_id and ( Get_Nav.Script_Name eq arguments.page_id or IsDefined("url.is_vdp_page"))>
				...
				<cfif len(trim(Get_Nav.Nav_Link)) gt 0>
					...
					<div class="row">
						<div class="md-col-12 pad-top-10" align="center">
							<a id="nav_#Get_Nav.nav_id#"class="#arguments.element_class# nav_#Get_Nav.Nav_ID#" href="#Get_Nav.Nav_Link#" title="#Get_Nav.Nav_Alt#">
								<img class="nav_#Get_Nav.Nav_ID# img-responsive" alt="#Get_Nav.Nav_Alt#" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#" border="0"/>
							</a>
						</div>
					</div>
		...
		<cfif variables.nav_count lte arguments.max_icons>
			...
			<cfloop query="Get_Nav">
				...
				<cfif Get_Nav.Nav_Type_ID eq arguments.nav_type_id>
					...
					<div class="col-md-#round(12/arguments.max_icons)#" align="center">
	...
	<cffunction name="standard" description="shows a standard nav element" output="Yes" access="public">
		...
		<cfinclude template="/aspen10/dealer/#arguments.assets#/data/nav_data_#nav_type_id#.cfm">
		...
		<cfloop list="#variables.nav_names#" index="main_nav" delimiters="^">
			...
			<cfswitch expression="#variables.behaviour#">
					...
					<cfelse>
						<cfif len(trim(variables.nav_roll_img)) eq 0>
							<a id="#variables.nav_id#" class="#variables.element_class#" href="#variables.nav_link#" title="#variables.alt#">
								<img class="#variables.nav_id# img-responsive" alt="#variables.alt#" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#variables.nav_img#" border="0"/>
							</a>						
						<cfelse>
				...
				<cfcase value="3">
					...
					<cfelse>
						<div id="#variables.nav_id#" class="#variables.element_class# #variables.nav_id#" title="#variables.alt#"><img class="img-responsive" alt="#variables.alt#" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#variables.nav_img#" border="0"/></div>
					</cfif>
				</cfcase>
				<cfcase value="6">
					<div id="#variables.nav_id#" class="#variables.element_class# #variables.nav_id#" title="#variables.alt#">#variables.main_nav#</div>
