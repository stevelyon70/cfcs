			...
			<div class="col-md-7">
				<div class="row">
					<div class="col-md-4 visible-lg visible-md">
						<cfinvoke component="/cfcs/aspen10/build_section" method="info_links">
							...
							<cfswitch expression="#Get_Nav.Nav_Behaviour_ID#">
								<cfcase value="1">
									<a href="#Get_Nav.Nav_Link#" title="#Get_Nav.Nav_Alt#">
										<img src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#"/>
									</a>								
								</cfcase>
								<cfcase value="2">
			...
			<cfloop query="Get_Nav">
				<div class="col-md-3 max-width" align="center">
					...
					<cfswitch expression="#Get_Nav.Nav_Behaviour_ID#">
						<cfcase value="1">
							<a href="#Get_Nav.Nav_Link#" title="#Get_Nav.Nav_Alt#">
								<img class="img-responsive" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#"/>
							</a>								
						</cfcase>
						<cfcase value="2">
							<a href="#Get_Nav.Nav_Link#" title="#Get_Nav.Nav_Alt#" target="_blank">
					...
					<cfcase value="1">
						<div align="center">
							<a  class="col-md-2 no-pad" href="#Get_Nav.Nav_Link#" title="#Get_Nav.Nav_Alt#">
								<img class="carousel-btn-mbl img-responsive" src="http://#cgi.server_name#/dealer/#arguments.assets#/images/icons/#Get_Nav.Nav_Image#"/>
							</a>
						</div>
					</cfcase>
					<cfcase value="2">
