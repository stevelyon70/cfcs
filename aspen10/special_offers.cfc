<cfcomponent>
	...
	<cffunction name="modern_legacy" description="shows legacy specials page" output="Yes" access="public">
		...
		<cfquery datasource="Ultra8" name="Get_Specials">
			...
			<cfif #url.Dealercode# EQ "0046-0018-999-01-5C86C17B1C" or #url.Dealercode# EQ "0046-0004-999-01-2158878870" or #url.Dealercode# EQ "0058-0002-999-01-814-781-10" > <!--- Faulkner Nissan Harrisburg & Jenkintown Seperate Special Offers --->
				...
				<div class="row legacy-spc-container" style="color:black;">
					<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-3 legacy-spc-btn">
								<a class="btn btn-grey" href="http://#cgi.server_name#/finance/calculator.cfm?price=#Get_Specials.Is_Price#" title="Calculate Payment" target="_blank"><img class="btn-icon" src="#variables.img_url#/icon_SM_Finance_off.png" alt="Calculate Payment"/>Calculate Payment</a>
							</div>
						</div>
						<div class="row">
