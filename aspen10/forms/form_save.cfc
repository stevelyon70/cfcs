<cfcomponent>
	...
	<cffunction name="insert_lead" description="Inserts basic lead data into db" output="Yes" access="public">
		...
		<cfargument name="lead_id_legacy" default="">
		...
		<cfquery datasource="Leads" name="Insert_Lead">
			...
			VALUES
				(
					...
					<cfif len(trim(arguments.delivery_id_legacy)) gt 0><cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.lead_id_legacy#" maxlength="10"><cfelse>NULL</cfif>
				)
		...
		<cfquery datasource="Leads" name="Save_Vehicle">
			...
			VALUES
				...
				(
					...
					<cfif isvalid("integer",arguments.v_mileage) eq "Yes"><cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.v_mileage#" maxlength="10"><cfelse>NULL</cfif>,					
					...
					<cfif isvalid("integer",arguments.mileage_min) eq "Yes"><cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.mileage_min#" maxlength="10"><cfelse>NULL</cfif>,
					<cfif isvalid("integer",arguments.mileage_max) eq "Yes"><cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.mileage_max#" maxlength="10"><cfelse>NULL</cfif>,
	...
	<cffunction name="check_submit" description="Checks to see if a user is submitting multiple times - designed to prevent spambots" output="Yes" access="public">
		...
		<cfset variables.tech_email="mikekosiorwd@gmail.com">
