<cfcomponent>
	...
	<cffunction name="show_default" description="display default contact us form" output="Yes" access="public">
		...
		<cfquery name="get_opp_detl" datasource="Aspen10">
		...
		<form class="form-horizontal" action="#arguments.form_action#" method="post" enctype="multipart/form-data">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-md-3" for="First_Name"><span class="txt-red">*</span>NEW First Name</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-md-6">                     
						<textarea name="Comments" class="form-control input-md" id="Comments" placeholder="Work History" maxlength="1000" required></textarea>
					</div>
				</div>
				<div class="form-group">
	...
	<cffunction name="form_submit" description="action page for form" output="Yes" access="public">
		...
		<cfset variables.save_file="E:\inetpub\wwwroot\Aspen10\resumes">
