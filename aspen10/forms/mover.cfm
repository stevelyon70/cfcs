	...
	<cffunction name="form_submit_sall" description="action page for form" output="Yes" access="public">
		...
		<cfelse> 
			...
			<cfif #Check_Pin.recordcount# eq 0>
				 ...
				 <cfmail to="wdsupport@worlddealer.net" from="#variables.from#" subject="Invalid Autoproval PIN" bcc="bob@worlddealer.net"  type="HTML">	 
	...
	<cfelse>
		...
		<cfmail to="#variables.recipient_list#" from="#variables.from#" subject="#variables.lead_subject#" bcc="wdsupport@worlddealer.net"   type="HTML">			
			...
			<cfif #Get_S_Dealer.dealer_id# eq 517>
						...
						<!---Send ADF Emails--->
							<cfmail to="liahyundhartford@eleadtrack.net" from="#variables.From#" subject="#variables.lead_subject#" bcc="wdsupport@worlddealer.net"  >
								#variables.adf_email#
						  </cfmail>  
			</cfif>
			<cfif #Get_S_Dealer.dealer_id# eq 513>
			...
			<cfif #Get_S_Dealer.dealer_id# eq 516>
						...
						<!---Send ADF Emails--->
							<cfmail to="liahyundenfield@eleadtrack.net" from="#variables.From#" subject="#variables.lead_subject#" bcc="wdsupport@worlddealer.net"  >
								#variables.adf_email#
						  </cfmail>  
			</cfif>
			<cfif #Get_S_Dealer.dealer_id# eq 510>
...
<!---Generate ADF Email--->
			...
			<!--- <cfif Get_Lead_Addresses.Email_ADF eq 1> --->
				...
				<cfmail to="aspenchrysler@worlddealerinc.com" from="#variables.From#" subject="#variables.lead_subject# - TEST ADF" >
				<!--- <cfmailparam name="Reply-To" value="#form.email#"> --->
				#variables.adf_email#
			  </cfmail>  
			
			
					  <!--- <cfmail to="bob@worlddealer.net" from="#variables.from#" subject="#variables.lead_subject# Take Two"  type="HTML">			
						<table cellpadding="0" width="70%" cellspacing="0">
							<tr><td colspan="2">&nbsp;</td></tr> 
							<tr><td colspan="2">&nbsp;</td></tr> 
							<tr>
