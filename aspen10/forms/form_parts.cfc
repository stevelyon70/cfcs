<cfcomponent>
	...
	<cffunction name="modern_default" description="display default contact us form" output="Yes" access="public">
		...
		<cfargument name="form_action" default="http://#cgi.server_name#/forms/parts_action.cfm">
		...
		<form id="test_drive" class="form-horizontal" action="#arguments.form_action#" method="post">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input name="VIN" class="form-control input-md" id="VIN" type="text" maxlength="50" placeholder="VIN" >
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="Voi_Year">Vehicle Year</label>
					<div class="col-md-6">
						<input name="Voi_Year" class="form-control input-md" id="Voi_Year" type="text" maxlength="4" placeholder="Year" onkeypress="return isNumberKey(event)" required>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="Voi_Make">Vehicle Make</label>
					<div class="col-md-6">
						<input name="Voi_Make" class="form-control input-md" id="Voi_Make" type="text" maxlength="50" placeholder="Make" required>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="Voi_Model">Vehicle Model</label>
					<div class="col-md-6">
						<input name="Voi_Model" class="form-control input-md" id="Voi_Model" type="text" maxlength="50" placeholder="Model" required>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-3" for="Parts_Comments">Parts Request Info</label>
					<div class="col-md-6">                     
						<textarea name="Parts_Comments" class="form-control input-md" id="Parts_Comments" placeholder="Parts Requested" maxlength="1000" required></textarea>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="submit" class="btn btn-primary" id="Contact_Us" value="Send Your Parts Request">
					</div>
				</div>
			</fieldset>
		</form>
	...
	<cffunction name="legacy_default" description="display default contact us form" output="Yes" access="public">
		...
		<form id="test_drive" class="form-horizontal" action="#arguments.form_action#" method="post">
			...
			<div class="form-group">
				<label class="control-label col-md-3" for="Voi_Year">Vehicle Year</label>
				<div class="col-md-6">
					<input name="Voi_Year" class="form-control input-md" id="Voi_Year" type="text" maxlength="4" placeholder="Year" required onkeypress="return isNumberKey(event)">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3" for="Voi_Make">Vehicle Make</label>
	...
	<cffunction name="form_submit" description="action page for form" output="Yes" access="public">
		...
		<cfparam name="form.parts_comments" default="">
		...
		<!--- Parts Comments: form.parts_comments --->
		<cfinvoke component="/cfcs/forms/form_validate" method="text_area" returnvariable="error_message">
			<cfinvokeargument name="text_name" value="Parts Requested"/>
			<cfinvokeargument name="text_value" value="#form.parts_comments#"/>
			<cfinvokeargument name="text_req" value="true"/>
			<cfinvokeargument name="error_message" value="#variables.error_message#"/>
		</cfinvoke>
		...
		<cfelse>
			...
			<cfinvoke component="/cfcs/forms/form_save" method="insert_vehicle">
				<cfinvokeargument name="New_ID" value="#variables.New_ID#"/>
				<cfinvokeargument name="Vehicle_Type_ID" value="7"/>
				...
				<cfinvokeargument name="VIN" value="#form.VIN#"/>
				<cfinvokeargument name="parts_comments" value="#form.parts_comments#"/>
			</cfinvoke>
			...
			<cfinvoke component="/cfcs/emails/adf_gen" method="vehicle_adf" returnvariable="adf_email">
				<cfinvokeargument name="adf_email" value="#variables.adf_email#"/>
				<cfinvokeargument name="interest" value="parts"/>
				<cfinvokeargument name="v_year" value="#form.voi_year#"/>
				<cfinvokeargument name="v_make" value="#form.voi_make#"/>
				<cfinvokeargument name="v_model" value="#form.voi_model#"/>
				<cfinvokeargument name="VIN" value="#form.VIN#"/>
				<cfinvokeargument name="v_comments" value="Parts Requested: #form.parts_comments#"/>
			</cfinvoke>
			...
			<cfparam name="variables.Email_Subject" default="Parts Request from #lcase(cgi.Server_Name)#">
