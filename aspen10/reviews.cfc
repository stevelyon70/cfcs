	...
	<cffunction name="modern_dealerrater" description="shows standard dealerrater display" output="Yes" access="public">
		...
		<div class="row">
			<div class="col-md-12  visible-md visible-lg">
				<cfinvoke component="/cfcs/aspen10/reviews" method="pagination">
						...
						<div class="col-md-6">
							<table cellpadding="0" cellspacing="0">
								<tr>
									...
									<td><cfloop from="1" to="#Get_Reviews.Rating_CustomerService#" index="i"><img src="http://#cgi.server_name#/images/logos/review-star-sm.png" title="#Get_Reviews.Rating_CustomerService# Star Review" /></cfloop></td>
									<td align="center"><b>#Get_Reviews.Rating_CustomerService#</b></td>
								</tr>
								<tr>
									<td>Quality of Work:&nbsp;</td>
									<td><cfloop from="1" to="#Get_Reviews.Rating_Quality#" index="i"><img src="http://#cgi.server_name#/images/logos/review-star-sm.png" title="#Get_Reviews.Rating_Quality# Star Review" /></cfloop></td>
									<td align="center"><b>#Get_Reviews.Rating_Quality#</b></td>
								</tr>
								<tr>
									<td>Friendliness:&nbsp;</td>
									<td><cfloop from="1" to="#Get_Reviews.Rating_Friendliness#" index="i"><img src="http://#cgi.server_name#/images/logos/review-star-sm.png" title="#Get_Reviews.Rating_Friendliness# Star Review" /></cfloop></td>
									<td align="center"><b>#Get_Reviews.Rating_Friendliness#</b></td>
								</tr>
								<tr>
									<td>Overall Experience:&nbsp;</td>
									<td><cfloop from="1" to="#Get_Reviews.Rating_Overall#" index="i"><img src="http://#cgi.server_name#/images/logos/review-star-sm.png" title="#Get_Reviews.Rating_Overall# Star Review" /></cfloop></td>
									<td align="center"><b>#Get_Reviews.Rating_Overall#</b></td>
								</tr>
								<tr>
									<td>Price:&nbsp;</td>
									<td><cfloop from="1" to="#Get_Reviews.Rating_Price#" index="i"><img src="http://#cgi.server_name#/images/logos/review-star-sm.png" title="#Get_Reviews.Rating_Price# Star Review" /></cfloop></td>
									<td align="center"><b>#Get_Reviews.Rating_Price#</b></td>
								</tr>
								<tr style="border-top:2px solid black;">
									<td><b>Overall Score:</b>&nbsp;</td>
									<td><cfloop from="1" to="#round(Get_Reviews.Overall_Score/5)#" index="i"><img src="http://#cgi.server_name#/images/logos/review-star-sm.png" title="#Get_Reviews.Overall_Score/5# Star Review" /></cfloop></td>
		...
		<div class="row">
			<div class="col-md-12 visible-xs visible-sm">
				<cfinvoke component="/cfcs/aspen10/reviews" method="pagination_next">
					<cfinvokeargument name="Recordcount" value="#Get_Reviews.Recordcount#"/>
				</cfinvoke>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<a href="http://www.dealerrater.com" target="_blank">
					<img class="img-responsive pull-right" src="http://#cgi.server_name#/images/logos/reviews_by_dealerrater.png" border="0" />
				</a>
			</div>
		</div>
