<cfcomponent>
	...
	<cffunction name="page_build" description="builds the splash page" output="Yes" access="public">
		...
		<cfargument name="Get_Phones" required="true">
		 ...
		 <cfinvoke component="/cfcs/Aspen10/build_header" method="#arguments.site_mode#">
		...
		<!--- <cfinvoke component="/cfcs/Aspen10/build_navigation" method="#arguments.site_mode#">
			<cfinvokeargument name="dealer_id" value="#arguments.dealer_id#"/>
			<cfinvokeargument name="dealer_name" value="#arguments.dealer_name#"/>
			<cfinvokeargument name="address_1" value="#arguments.address_1#"/>
			<cfinvokeargument name="address_2" value="#arguments.address_2#"/>
	...
	<cfif #arguments.dealer_id# EQ 133 or  #arguments.dealer_id# EQ 198>
		<cfinvoke component="/cfcs/Aspen10/templates/#url.template_id#/content_splash" method="#url.site_mode#">
			<cfinvokeargument name="dealer_id" value="#arguments.dealer_id#"/>
			<cfinvokeargument name="dealer_name" value="#arguments.dealer_name#"/>
			<cfinvokeargument name="address_1" value="#arguments.address_1#"/>
			<cfinvokeargument name="address_2" value="#arguments.address_2#"/>
	...
	<cfelse>	
		<cfset variables.method = "modernreg" >
		<cfif #url.dealer_id# eq 199 >
			<cfif IsDefined("url.wch") >
				<cfset variables.method = "modernregthankyou" >
			</cfif>
		</cfif>
		<cfif #url.dealer_id# eq 203  >
			<cfif IsDefined("url.wch") >
				<cfset variables.method = "modernbaierlregthankyou" >
			</cfif>
		</cfif>
		<cfinvoke component="/cfcs/Aspen10/templates/#url.template_id#/content_splash" method="#variables.method#">
			<cfinvokeargument name="dealer_id" value="#arguments.dealer_id#"/>
			<cfinvokeargument name="dealer_name" value="#arguments.dealer_name#"/>
			<cfinvokeargument name="address_1" value="#arguments.address_1#"/>
			<cfinvokeargument name="address_2" value="#arguments.address_2#"/>
		...
		<!--- <cfinvoke component="/cfcs/Aspen10/build_footer" method="#url.site_mode#_center">
			<cfinvokeargument name="dealer_id" value="#arguments.dealer_id#"/>
			<cfinvokeargument name="dealer_name" value="#arguments.dealer_name#"/>
			<cfinvokeargument name="address_1" value="#arguments.address_1#"/>
			<cfinvokeargument name="address_2" value="#arguments.address_2#"/>
