...
<cfcomponent>
	...
	<cffunction name="modern" description="Toyota TAP Form" output="Yes" access="public">
		<!--- arguments --->
					...
					<div class="row">
						<div class="row">
							<div class="col-md-7 pull right" align="right" style="color:##231f20 ;font-family: Helvetica, Arial, sans-serif;font-size:10pt" >	
								<img src="http://#cgi.server_name#/dealer/#variables.dlr_dir#/images/icons/Toy_TradeBooster_640x360_V2.jpg" border="0" class="img-responsive"> <br>
							...
							<div class="col-md-5 pull right" align="center" style="color:##231f20 ;font-family: Helvetica, Arial, sans-serif;font-size:10pt" >	
								<img src="http://#cgi.server_name#/dealer/#variables.dlr_dir#/images/icons/Toy_TradeBooster_R-SIDE-TEXT.jpg" border="0" class="img-responsive"> 
