<cfcomponent>
	...
	<cffunction name="modern" description="shows a standard footer" output="Yes" access="public">
		...
		<cfquery name="get_ftr_img" datasource="Aspen10">SELECT   wd_logo_img FROM   Dealers WHERE	Dealer_ID=#url.dealer_id#</cfquery>
				...
				<div class="row no-pad">
					<div class="col-md-5">
						<cfswitch expression="#url.dealer_id#">
							...
							<cfcase value="32,34,33,51,36,24,233"></cfcase> 
						</cfswitch>
					</div>
					<div class="col-md-4">
					...
					<div class="col-md-3" align="right">
						...
						<cfelse>
							<a class="footer-pgtxt" href="http://www.worlddealer.net" target="_blank"><img src="http://dealers.wdautos.com/images/wd_logos/#ftr_img#" class="img-responsive" border="0"></a>
						</cfif>
					</div>
				</div>
			</div>
	...
	<cffunction name="nissan_modern" description="shows a nissan compliant footer" output="Yes" access="public">
		...
		<cfinvoke component="/cfcs/aspen10/popups" method="nissan_copyright">
				...
				<table style="width:100%;" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td style="width:50%" align="right">
							...
							|<a class="nissan-ftr-link" href="http://#cgi.server_name#/forms/contact.cfm">Contact Us</a>
							|<a class="nissan-ftr-link" href="http://#cgi.server_name#/finance/privacy.cfm">Privacy Statement</a>
							<a class="nissan-ftr-logo" href="http://www.nissanusa.com/" target="_blank"><img src="http://#cgi.server_name#/images/oem/nissan/nissan_footer.png" border="0"/></a>							
						</td>
					</tr>
				</table>
			</div>
