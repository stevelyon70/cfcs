<cfcomponent>
	...
	<cffunction name="modern_standard" description="shows standard dealer hours" output="Yes" access="public">
		...
		<cfquery datasource="Aspen10" name="Get_Specials">
				...
				<div class="row">
					<div class="col-md-12" align="center">
						<cfif len(trim(Get_Specials.Special_Image)) gt 0>
							<img class="img-responsive" src="http://#cgi.server_name#/dealer/#url.assets#/images/icons/#Get_Specials.Special_Image#"/>
						</cfif>
					</div>
				</div>
			</cfloop>
		<cfelse>
			<div class="row">
				<div class="col-md-12" align="center">
					<img class="img-responsive" src="http://#cgi.server_name#/images/inventory/ads_header.png"/>
				</div>
			</div>
		...
		<cfif Get_Specials.Recordcount gt 0>
			<cfloop query="Get_Specials">
				<tr>
					<td align="center">
						<cfif len(trim(Get_Specials.Special_Image)) gt 0>
							<img src="http://#cgi.server_name#/dealer/#url.assets#/images/icons/#Get_Specials.Special_Image#"/>
						</cfif>
					</td>
				</tr>
			</cfloop>
