<cfcomponent>
	...
	<cffunction name="get_colors" description="get colors" output="Yes" access="public">
		...
		<!--- <select name="#arguments.select_name#">
			...
			or --->
		<input name="#arguments.select_name#" value="#arguments.select_value#" type="text" size="12" maxlength="12"> <span style="color:blue;font-size:8pt">6 digits, "transparent", or leave blank</span>	
