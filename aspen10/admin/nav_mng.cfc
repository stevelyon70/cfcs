...
<!---		<cfset Get_Nav=arguments.Get_Nav>
	...
	<cffunction name="get_legacy_nav" description="gets dealer legacy videos" output="Yes" access="public">
		...
		<cfquery datasource="Ultra8" name="Get_Legacy_Nav">
			...
			AND			Nav_Custom_ID not in (Select Legacy_Nav_Custom_ID from Aspen10.dbo.Navigation where #arguments.Site_ID_Name# = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.Site_ID#" maxlength="4"> and Legacy_Nav_Custom_ID is not null)
			ORDER BY 	Hierarchy
		</cfquery>
