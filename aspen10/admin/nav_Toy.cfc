	...
	<cffunction name="get_nav" description="gets current nav listing" output="Yes" access="public">
		...
		<cfquery datasource="#arguments.DSN#" name="Get_Phones">
			SELECT		Phone_ID,
						...
						Prefix,
						Line_Number
			FROM		Aspen10.dbo.Dealer_Phones
...
<!---		<cfset Get_Nav=arguments.Get_Nav>
		...
		<cfset variables.data_file="E:\inetpub\wwwroot\Aspen10\dealer\#arguments.Dealer_Directory#\data">
	...
	<cffunction name="get_legacy_nav" description="gets dealer legacy videos" output="Yes" access="public">
		...
		<cfquery datasource="Ultra8" name="Get_Legacy_Nav">
			...
			AND			Nav_Custom_ID not in (Select Legacy_Nav_Custom_ID from Aspen10.dbo.CAMNavigation where #arguments.Site_ID_Name# = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.Site_ID#" maxlength="4"> and Legacy_Nav_Custom_ID is not null)
			ORDER BY 	Hierarchy
		</cfquery>
	...
	<cffunction name="import_legacy" description="gets dealer legacy videos" output="Yes" access="public">
		...
		<cfif listlen(form.Nav_Custom_ID) gt 0>
			...
			<cfloop list="#form.Nav_Custom_ID#" index="myid">
				...
				<cfquery datasource="Aspen10" name="Get_New_Dealer">
				...
				<cfif len(trim(Get_Legacy_Nav.Icon_Image)) gt 0>
					<cffile action="append" file="E:\transfers\import_img.bat" output="copy \\WDWEB4\inetpub\wwwroot\Ultra9\dealer\#Get_Dealer.File_Dir#\#arguments.Save_Directory#\#Get_Legacy_Nav.Icon_Image# E:\inetpub\wwwroot\Aspen10\dealer\#Get_New_Dealer.Dealer_Directory#\#arguments.Save_Directory# /Y" addnewline="Yes">
				</cfif>

				<cfif len(trim(Get_Legacy_Nav.Icon_Rollover)) gt 0>
					<cffile action="append" file="E:\transfers\import_img.bat" output="copy \\WDWEB4\inetpub\wwwroot\Ultra9\dealer\#Get_Dealer.File_Dir#\#arguments.Save_Directory#\#Get_Legacy_Nav.Icon_Rollover# E:\inetpub\wwwroot\Aspen10\dealer\#Get_New_Dealer.Dealer_Directory#\#arguments.Save_Directory# /Y" addnewline="Yes">
				</cfif>

				<cfquery datasource="Aspen10" name="Get_H">
					SELECT		max(Hierarchy) as max_h
					FROM		#arguments.Table_Name#
				...
				<cfquery datasource="Aspen10" name="Insert_Nav">
