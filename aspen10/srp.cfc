<cfcomponent>
	...
	<cffunction name="srp_default" description="shows default vdp page" output="Yes" access="public">
		...
		<!---Get Vehicle Details--->
		<cfstoredproc datasource="Aspen10" procedure="Get_Vehicles">
								...
								<div class="col-md-12 srp-row">
									<div class="row">
										<div class="col-md-5">
											...
											<cfinvoke component="/cfcs/aspen10/vehicle_photos" method="single_photo">
										...
										<div class="col-md-4 visible-md visible-lg">
											...
											<div>
												<cfinvoke component="/cfcs/aspen10/vehicle_specs" method="vdp_default">
										...
										<div class="col-md-3">
											<cfinvoke component="/cfcs/aspen10/vehicle_pricing" method="vdp_default">
									...
									<div class="row">
										<cfswitch expression="#arguments.srp_btns#">
											<cfdefaultcase>
												<cfinvoke component="/cfcs/aspen10/vehicle_btns" method="srp_standard">
