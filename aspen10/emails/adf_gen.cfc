<cfcomponent>
	...
	<cffunction name="contact_adf" description="add contact info to adf email" output="No" access="public">
		...
		<cfargument name="employment" default="">
		<cfargument name="income" default="">
		<cfargument name="appointment" default="">
		<cfargument name="appointment_time" default="">
		...
		<cfset variables.adf_email=variables.adf_email & '<customer>' & "#chr(10)#">
			<cfset variables.adf_email=variables.adf_email & '<contact>' & "#chr(10)#">
				...
				<cfif len(trim(arguments.pin)) gt 0>
					<cfset variables.adf_email=variables.adf_email & '<pin>#arguments.pin#</pin>' & "#chr(10)#">
				</cfif><!--- 
				<cfif len(trim(arguments.age)) gt 0>
					<cfset variables.adf_email=variables.adf_email & '<age>#arguments.age#</age>' & "#chr(10)#">
				</cfif>
				<cfif len(trim(arguments.employment)) gt 0>
					<cfset variables.adf_email=variables.adf_email & '<employment>#arguments.employment#</employment>' & "#chr(10)#">
				</cfif>
				<cfif len(trim(arguments.income)) gt 0>
					<cfset variables.adf_email=variables.adf_email & '<income>#arguments.income#</income>' & "#chr(10)#">
				</cfif>
				<cfif len(trim(arguments.appointment)) gt 0>
					<cfset variables.adf_email=variables.adf_email & '<appointment>#arguments.appointment#</appointment>' & "#chr(10)#">
				</cfif>
				<cfif len(trim(arguments.appointment_time)) gt 0>
					<cfset variables.adf_email=variables.adf_email & '<appointment_time>#arguments.appointment_time#</appointment_time>' & "#chr(10)#">
				</cfif> --->
			...
			<!--- <cfset variables.adf_email=variables.adf_email & '<comments>#arguments.comments#</comments>' & "#chr(10)#"> --->
			 <cfset variables.adf_email=variables.adf_email & '<comments>' & "#chr(10)#"> 
				<cfif len(trim(arguments.appointment)) gt 0>
					<cfset variables.adf_email=variables.adf_email & 'Appointment: #arguments.appointment# #arguments.appointment_time#' & "#chr(10)#">
				</cfif>
				<cfif len(trim(arguments.age)) gt 0>
					<cfset variables.adf_email=variables.adf_email & 'Age: #arguments.age#' & "#chr(10)#">
				</cfif>
				<cfif len(trim(arguments.income)) gt 0>
					<cfset variables.adf_email=variables.adf_email & 'Income: #arguments.income#' & "#chr(10)#">
				</cfif>
				<cfif len(trim(arguments.employment)) gt 0>
					<cfset variables.adf_email=variables.adf_email & 'Employment: #arguments.employment#' & "#chr(10)#">
				</cfif>
	...
	<cffunction name="vehicle_adf" description="add vehicle info to adf email" output="No" access="public">
		...
		<cfif len(trim(arguments.v_vin)) gt 0>
			<cfstoredproc datasource="Aspen10" procedure="Get_Vehicle_Details">
	...
	<cffunction name="vendor_adf" description="add vendor info to adf email" output="No" access="public">
		...
		<cfstoredproc datasource="Aspen10" procedure="Get_Dealer_Info">
		...
		<cfstoredproc datasource="Aspen10" procedure="Get_Primary_Phone">
		...
		<cfstoredproc datasource="Aspen10" procedure="Get_Primary_URL">
			<cfprocparam type="In" cfsqltype="CF_SQL_INTEGER" dbvarname="@dealer_id" value="#arguments.dealer_id#" maxlength="10">
		...
		<cfset variables.adf_email=variables.adf_email & '<vendor>' & "#chr(10)#">
			...
			<cfset variables.adf_email=variables.adf_email & '<contact>' & "#chr(10)#">
				...
				<cfset variables.adf_email=variables.adf_email & '<address>' & "#chr(10)#">
					...
					<cfset variables.adf_email=variables.adf_email & '<url>http://#Get_Primary_URL.web_link#</url>' & "#chr(10)#">
				<cfset variables.adf_email=variables.adf_email & '</address>' & "#chr(10)#">
			<cfset variables.adf_email=variables.adf_email & '</contact>' & "#chr(10)#">
		<cfset variables.adf_email=variables.adf_email & '</vendor>' & "#chr(10)#">
	...
	<cffunction name="provider_adf" description="add provider info to adf email" output="No" access="public">
		...
		<cfset variables.adf_email=variables.adf_email & '<provider>' & "#chr(10)#">
			...
			<cfset variables.adf_email=variables.adf_email & '<name part="full" type="business">WorldDealer, Inc.</name>' & "#chr(10)#">
			<cfset variables.adf_email=variables.adf_email & '<service part="full">Automotive Website Provider</service>' & "#chr(10)#">
