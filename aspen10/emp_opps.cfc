...
<!--- Data Collection --->
	...
	<cffunction name="modern_standard" description="create standard Opportunity page" output="yes" access="public">
		...
		<cfquery name="get_opp_list" datasource="#variables.DSN#">
			SELECT  ID, Dealer_ID, Emp_Title, Department, Emp_Location, Position_Type, Emp_Compensation, Emp_Short_Description,Emp_Description, 
		...
		<cfloop query="get_opp_list" >
			...
			<cfelse> 
				...
				<div class="row"><div class="col-md-1"></div><div class="col-md-11">Location: <b>#get_opp_list.Emp_Location#</b> Type: <b>#get_opp_list.Position_Type#</b></div></div>
				<div class="row"><div class="col-md-1"></div><div class="col-md-11">Added: <b>#dateformat(get_opp_list.Emp_Posted,"mm/dd/yyyy")#</b></div></div><p></p>
	...
	<cffunction name="modern_standard_step_two" description="create Detail Opportunity page" output="yes" access="public">
		...
		<div class="row"><div class="col-md-1"></div><div class="col-md-11" style="font-size:16pt; font-weight:bold">#get_opp_list.Emp_Title#</div></div>
		<div class="row"><div class="col-md-1"></div><div class="col-md-11">Location: <b>#get_opp_list.Emp_Location#</b> Type: <b>#get_opp_list.Position_Type#</b></div></div>
		<div class="row"><div class="col-md-1"></div><div class="col-md-11">Added: <b>#dateformat(get_opp_list.Emp_Posted,"mm/dd/yyyy")#</b></div></div>
