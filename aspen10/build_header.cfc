	...
	<cffunction name="modern" description="shows a standard header" output="Yes" access="public">
		...
		<header class="section-hdr">
			...
			<div class="container row-hdr visible-sm visible-xs">
				...
				<cfif #url.dealer_id# NEQ 198 AND  #url.dealer_id# NEQ 133 and #url.dealer_id# NEQ 199 AND  #url.dealer_id# NEQ 197  AND  #url.dealer_id# NEQ 203  > <!--- Remove Get Directions on Mobile Forms --->
					<div class="row">
						<div class="col-md-12">
