<cfcomponent>
	...
	<cffunction name="wide" description="slideshow" output="Yes" access="public">
		...
		<cfquery datasource="Aspen10" name="Get_Slides">
								...
								<cfswitch expression="#Get_Slides.Nav_Behaviour_ID#">
									...
									<cfcase value="1">
										...
										<cfif #Get_Slides.From_Dealer# eq "1" >
											...
											<img class="img-responsive" src="#Get_Slides.Nav_Image#" border="0" alt="#variables.img_title#" title="#variables.img_title#" id="wows1_#variables.nav_count-1#"/>
											</a>											
										<cfelse>										
