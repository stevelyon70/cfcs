<cfcomponent>
	...
	<cffunction name="srp" description="search results page" output="Yes" access="public">
		...
		<cfargument name="Dealer_Url" required="true"/>
			...
			<div class="col-md-12 srp-row">
				<div class="row">
						...
						<cfif len(trim(arguments.My_Zip)) gt 0>
							<cfloop query="Get_Dealers_Zip">
								<cfif Get_Dealers_Zip.Dealer_ID eq arguments.Dealer_ID>
									<cfif isvalid("Numeric" ,Get_Dealers_Zip.Distance) eq "Yes">
										<div align="center"><b>#round(Get_Dealers_Zip.Distance)# miles from #arguments.My_Zip#</b></div>
									<cfelse>
										<div align="center"><b>Distance could not be Calucated</b></div>
									</cfif>
					...
					<div class="col-md-5 srp-specs visible-md visible-lg">
						...
						<cfinvoke component="/cfcs/automall/vehicle_specs" method="vdp_default">
					...
					<div class="col-md-3">
						<cfinvoke component="/cfcs/automall/vehicle_pricing" method="vdp_default">
				...
				<div class="row">
					<div class="col-md-12">
						<cfinvoke component="/cfcs/automall/vehicle_btns" method="srp_standard">
							<cfinvokeargument name="Voi_Vin" value="#arguments.Vin#"/>
	...
	<cffunction name="vdp" description="search results page" output="Yes" access="public">
		...
		<cflock timeout="60">
			<cfquery datasource="Automall" name="Get_Similar">
				...
				AND			Automall_ID = <cfqueryparam cfsqltype="cf_sql_integer" value="#arguments.automall_id#" maxlength="2">
		...
		<!---vdp track code--->
		<cfinvoke component="/cfcs/automall/click_track" method="vin">
			<cfinvokeargument name="vin" value="#arguments.vin#"/>
			<cfinvokeargument name="description" value="#arguments.V_New_Used# - #arguments.Stock# - #arguments.V_Year# #arguments.V_Make# #arguments.V_Model# #arguments.V_Trim#"/>
			<cfinvokeargument name="click_dir" value="E:\inetpub\wwwroot\automall\clicks\#arguments.automall_id#\vdp\#arguments.dealer_id#"/>
		</cfinvoke>
		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="row">
					<div class="col-md-8">
						<cfinvoke component="/cfcs/automall/vehicle_photos" method="bx_slider">
					...
					<div class="col-md-4">
						...
						<div class="row visible-xs visible-sm">
							<div class="vdp-form-mobile">
								<cfinvoke component="/cfcs/automall/vehicle_store" method="vdp_default">
								...
								<cfinvoke component="/cfcs/automall/vehicle_quote_form" method="qq_default">
									<cfinvokeargument name="VOI_Vin" value="#arguments.Vin#"/>
								...
								<cfinvoke component="/cfcs/automall/vehicle_btns" method="vdp_standard">
									<cfinvokeargument name="VOI_Vin" value="#arguments.Vin#"/>
									<cfinvokeargument name="dealer_id" value="#arguments.dealer_id#"/>
				...
				<div class="row vdp-options-box visible-md visible-lg">
					...
					<div class="col-md-12 vdp-text-sm vdp-options-div">
						<cfinvoke component="/cfcs/automall/vehicle_options" method="vdp_default">
				...
				<div class="row visible-xs visible-sm">
					...
					<div class="col-md-12 vdp-text-sm ">
						<cfinvoke component="/cfcs/automall/vehicle_options" method="vdp_mobile">
							<cfinvokeargument name="Installed" value="#Get_Vehicle_Options.Installed#"/>
							<cfinvokeargument name="Safety" value="#Get_Vehicle_Options.Safety#"/>
							<cfinvokeargument name="Interior" value="#Get_Vehicle_Options.Interior#"/>
							<cfinvokeargument name="Exterior" value="#Get_Vehicle_Options.Exterior#"/>
				...
				<div class="row vdp-options-box">
					<div class="col-md-12 vdp-text vdp-pad-10 mar-bot-10">
						<div class="col-md-12">
							<b>PAYMENT CALCULATOR:</b>
						</div>
						<div class="col-md-12 vdp-pad-10">
							<cfinvoke component="/cfcs/automall/calculator" method="vdp">
								<cfinvokeargument name="automall_id" value="#arguments.automall_id#"/>
								<cfinvokeargument name="Dealer_ID" value="#arguments.Dealer_ID#"/>
			...
			<div class="col-md-3 visible-md visible-lg vdp-text-sm">
				...
				<div class="vdp-form-box">
					...
					<cfif Get_Similar.recordcount gt 0>
						...
						<cfinvoke component="/cfcs/automall/vehicle_similar" method="vdp_similar">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-md-6">
									<div class="pop-form-box">
										<cfinvoke component="/cfcs/automall/form_send_friend" method="form_popup">
											<cfinvokeargument name="VOI_Vin" value="#arguments.Vin#"/>
		...
		<cfswitch expression="#url.form_action#">
			<cfcase value="submit_quote">
				<cfinvoke component="/cfcs/automall/form_quick_quote" method="form_submit">
					<cfinvokeargument name="Automall_ID" value="#arguments.Automall_ID#"/>
					<cfinvokeargument name="VOI_Vin" value="#arguments.Vin#"/>
				</cfinvoke>
			</cfcase>
			<cfcase value="td_submit">
				<cfinvoke component="/cfcs/automall/form_test_drive" method="form_submit">
					<cfinvokeargument name="Automall_ID" value="#arguments.Automall_ID#"/>
					<cfinvokeargument name="VOI_Vin" value="#arguments.Vin#"/>
				</cfinvoke>
			</cfcase>
			<cfcase value="friend_submit">
				<cfinvoke component="/cfcs/automall/form_send_friend" method="form_submit">
					<cfinvokeargument name="Automall_ID" value="#arguments.Automall_ID#"/>
					<cfinvokeargument name="VOI_Vin" value="#arguments.Vin#"/>
				</cfinvoke>			
			</cfcase>
	...
	<cffunction name="data" description="search results page" output="Yes" access="public">
		...
		<cfinvoke component="/cfcs/automall/click_track" method="vin">
			<cfinvokeargument name="vin" value="#arguments.vin#"/>
			<cfinvokeargument name="description" value="#arguments.V_New_Used# - #arguments.Stock# - #arguments.V_Year# #arguments.V_Make# #arguments.V_Model# #arguments.V_Trim#"/>
			<cfinvokeargument name="click_dir" value="E:\inetpub\wwwroot\automall\clicks\#arguments.automall_id#\print\#arguments.dealer_id#"/>
		</cfinvoke>
	...
	<cffunction name="dataV1" description="search results page" output="Yes" access="public">
	...
	<div class="row">
		<!--- <div class="col-md-12"> --->
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-12">
						<cfinvoke component="/cfcs/automall/vehicle_photos" method="single_photov1">
							<cfinvokeargument name="automall_id" value="#arguments.automall_id#"/>
							<cfinvokeargument name="automall_name" value="#arguments.automall_name#"/>
							<cfinvokeargument name="template_id" value="#arguments.template_id#"/>
							<cfinvokeargument name="Img_Urls" value="#arguments.Img_Urls#"/>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="row">
				<div class="col-md-12">
					<cfinvoke component="/cfcs/automall/vehicle_options" method="vdp_mobile_new">
						<cfinvokeargument name="Installed" value="#Get_Vehicle_Options.Installed#"/>
						<cfinvokeargument name="Safety" value="#Get_Vehicle_Options.Safety#"/>
						<cfinvokeargument name="Interior" value="#Get_Vehicle_Options.Interior#"/>
						<cfinvokeargument name="Exterior" value="#Get_Vehicle_Options.Exterior#"/>
	...
	<cffunction name="dataV2" description="search results page" output="Yes" access="public">
	...
	<table width="100%" border="0" cellpadding="3" cellspacing="3" >
		...
		<tr>
			...
			<td align="left" width="50%" valign="TOP"  >
						...
						<cfinvoke component="/cfcs/automall/vehicle_pricing" method="vdp_default_prt">
							<cfinvokeargument name="Selling_Price_Label" value="#arguments.Selling_Price_Label#"/>
							<cfinvokeargument name="Selling_Price" value="#arguments.Selling_Price#"/>
							<cfinvokeargument name="MSRP_Label" value="#arguments.MSRP_Label#"/>
							<cfinvokeargument name="MSRP_Price" value="#arguments.MSRP_Price#"/>
						...
						<cfinvoke component="/cfcs/automall/vehicle_specs" method="vdp_default_prt">
							<cfinvokeargument name="New_Used" value="#arguments.V_New_Used#"/>
							<cfinvokeargument name="Stock" value="#arguments.Stock#"/>
							<cfinvokeargument name="Model_Number" value="#arguments.Model_Number#"/>
							<cfinvokeargument name="Vin" value="#arguments.Vin#"/>
	...
	<table width="100%" border="0" cellpadding="0" scellspacing="0" >
