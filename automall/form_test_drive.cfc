			...
			<fieldset>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group">
							<label class="col-md-3 control-label visible-md visible-lg" for="td_date"><em>*</em> Date</label>  
							<div class="col-md-7">
								<input name="td_date" class="form-control input-md" id="td_date" type="text" placeholder="Test Drive Date" maxlength="10" value="#url.td_date#" required/>
								<span class="help-block">format - mm/dd/yyyy</span>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-3 control-label visible-md visible-lg" for="td_time"><em>*</em> Time</label>  
							<div class="col-md-7">
								<select class="form-control input-md" name="td_time" required>
