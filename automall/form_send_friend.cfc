		...
		<form class="form-horizontal no-pad" action="#arguments.form_action#?form_action=friend_submit&vin=#left(arguments.VOI_Vin,17)#" id="#arguments.form_name#" name="#arguments.form_name#" method="post">
			<fieldset>
				...
				<div class="form-group">
					<label class="col-md-4 control-label visible-md visible-lg" for="first_name"><em>*</em> Your Name</label>
					<div class="col-md-7">
						<input name="first_name" class="form-control input-md" id="first_name" type="text" placeholder="Your Name" maxlength="50" value="#url.first_name#" required/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 control-label visible-md visible-lg" for="email"><em>*</em>Your Email</label>  
					<div class="col-md-7">
						<input name="email" class="form-control input-md" id="email" type="email" placeholder="Your Email" maxlength="100" value="#url.first_name#" required/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 control-label visible-md visible-lg" for="friend_name"><em>*</em> Your Friend's Name</label>
					<div class="col-md-7">
						<input name="friend_name" class="form-control input-md" id="friend_name" type="text" placeholder="Your Friend's Name" maxlength="50" value="#url.friend_name#" required/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 control-label visible-md visible-lg" for="friend_email"><em>*</em>Your Friend's Email</label>  
					<div class="col-md-7">
						<input name="friend_email" class="form-control input-md" id="friend_email" type="friend_email" placeholder="Your Friend's Email" maxlength="100" value="#url.friend_email#" required/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 control-label visible-md visible-lg" for="comments">Comments</label>
					<div class="col-md-7">                     
						<textarea name="comments" class="form-control" id="comments" maxlength="500" placeholder="Comments" rows="8">#url.comments#</textarea>
					</div>
